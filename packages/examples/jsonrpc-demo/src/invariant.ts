/**
 * Package-owned invariant companion for `@harness-desktop/dsh-sdk-jsonrpc-demo`.
 * @module @harness-desktop/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-sdk-jsonrpc-demo'
