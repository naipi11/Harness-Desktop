/**
 * Package-owned invariant companion for `@stackstackstack/dsh-sdk-jsonrpc-demo`.
 * @module @stackstackstack/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-sdk-jsonrpc-demo'
