/**
 * Package-owned invariant companion for `@stackstackstack/dsh-agent-spine-demo`.
 * @module @stackstackstack/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-agent-spine-demo'
