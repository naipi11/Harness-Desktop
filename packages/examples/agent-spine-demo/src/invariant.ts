/**
 * Package-owned invariant companion for `@harness-desktop/dsh-agent-spine-demo`.
 * @module @harness-desktop/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-agent-spine-demo'
