 ...
 * @module @stackstackstack/dsh-agent-spine-demo
 */

import type { Context } from '@deepseek-ai/cordis'
import Timer from '@deepseek-ai/cordis-plugin-timer'
import z from '@deepseek-ai/schemastery'
import LlmRuntime from '@stackstackstack/dsh-llm'
import SessionStore from '@stackstackstack/dsh-session'
import SessionTitleService, { type Config as SessionTitleConfig } from '@stackstackstack/dsh-session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@stackstackstack/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@stackstackstack/dsh-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@stackstackstack/dsh-skill'
import * as SkillFileSystem from '@stackstackstack/dsh-skill-filesystem'
import AgentRegistry from '@stackstackstack/dsh-agent'
import GoalService, { type Config as GoalDomainConfig } from '@stackstackstack/dsh-goal'
import * as goalSession from '@stackstackstack/dsh-goal-round-driver'
import * as toolGoal from '@stackstackstack/dsh-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@stackstackstack/dsh-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@stackstackstack/dsh-invariants'
import * as sessionInvariant from '@stackstackstack/dsh-session/invariant'
import * as agentInvariant from '@stackstackstack/dsh-agent/invariant'
import * as scopeInvariant from '@stackstackstack/dsh-scope/invariant'
import * as agentLoopInvariant from '@stackstackstack/dsh-agent-loop/invariant'
import * as toolBash from '@stackstackstack/dsh-tool-bash'
import * as bashEnv from '@stackstackstack/dsh-shell-env'
import * as workspaceContext from '@stackstackstack/dsh-agent-instructions'
import * as toolSkill from '@stackstackstack/dsh-tool-skill'
import * as toolJobs from '@stackstackstack/dsh-tool-jobs'
import AgentLoop, { type Config as AgentLoopConfig } from '@stackstackstack/dsh-agent-loop'
import * as llmRetry from '@stackstackstack/dsh-llm-retry'
