...
import { renderPrompt, TOOL_ORDER_REST } from '@stackstackstack/dsh-system-prompt'
import * as agentCore from '../src/index.ts'
import { agentEvents, type Agent } from '@stackstackstack/dsh-agent'
...
import type { ToolExecution } from '@stackstackstack/dsh-tools'
...
/**
 * Unit coverage for the @stackstackstack/dsh-agent-spine-demo bundle: mounting it brings
...
describe('dsh-agent-spine-demo bundle', () => {
  ...
  it('mounts package companions and forwards invariant selection config', async () => {
    ...
    for (const invariants of [
      { enabled: false },
      { package_allowlist: ['^@stackstackstack/dsh-agent$'] },
      { package_blocklist: ['^@stackstackstack/dsh-session$'] },
    ]) {
