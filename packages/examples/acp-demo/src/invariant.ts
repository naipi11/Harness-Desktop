/**
 * Package-owned invariant companion for `@harness-desktop/dsh-acp-demo`.
 * @module @harness-desktop/dsh-acp-demo/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-acp-demo'
