/**
 * Package-owned invariant companion for `@stackstackstack/dsh-acp-demo`.
 * @module @stackstackstack/dsh-acp-demo/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-acp-demo'
