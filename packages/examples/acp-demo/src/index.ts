 ...
 * ({@link @harness-desktop/dsh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @harness-desktop/dsh-acp} bridge. The app owns those plugins through one
 ...
 * @module @harness-desktop/dsh-acp-demo
 */

import type { Context } from '@harness-desktop/cordis'
import { join } from 'node:path'
import z from '@harness-desktop/schemastery'
import * as acp from '@harness-desktop/dsh-acp'
import * as agentCore from '@harness-desktop/dsh-agent-spine-demo'
...
} from '@harness-desktop/dsh-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@harness-desktop/dsh-session-checkpoint-policy'
