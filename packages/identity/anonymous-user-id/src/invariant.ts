/**
 * Package-owned invariant companion for `@stackstackstack/dsh-anonymous-user-id`.
 * @module @stackstackstack/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-anonymous-user-id'
