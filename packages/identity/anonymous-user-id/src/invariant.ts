/**
 * Package-owned invariant companion for `@harness-desktop/dsh-anonymous-user-id`.
 * @module @harness-desktop/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-anonymous-user-id'
