/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-jobs`.
 * @module @stackstackstack/dsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-jobs'
