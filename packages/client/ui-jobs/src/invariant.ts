/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-jobs`.
 * @module @harness-desktop/dsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-jobs'
