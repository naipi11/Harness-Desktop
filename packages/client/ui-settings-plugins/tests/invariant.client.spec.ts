...
import * as PluginConfigInvariant from '@harness-desktop/dsh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@harness-desktop/dsh-client-ui-settings-plugins')
