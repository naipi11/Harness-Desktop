...
import * as PluginConfigInvariant from '@stackstackstack/dsh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@stackstackstack/dsh-client-ui-settings-plugins')
