...
import type { SettingsScope, SettingsScopeSnapshot } from '@stackstackstack/dsh-client-runtime/client'
import { createSnapshotStore, type SnapshotStore } from '@stackstackstack/dsh-client-runtime/client'
