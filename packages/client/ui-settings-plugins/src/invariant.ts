/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-settings-plugins`.
 * @module @stackstackstack/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-settings-plugins'
