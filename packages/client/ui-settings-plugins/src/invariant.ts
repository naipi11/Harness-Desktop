/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-settings-plugins`.
 * @module @harness-desktop/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-settings-plugins'
