/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-plan`.
 * @module @harness-desktop/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-plan'
