/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-plan`.
 * @module @stackstackstack/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-plan'
