/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-model-selection`.
 * @module @stackstackstack/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-model-selection'
