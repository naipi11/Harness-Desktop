...
import type { ModelSelection, SessionModels } from '@stackstackstack/dsh-api-remotes/client'
import type { ClientContext } from '@stackstackstack/dsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@stackstackstack/dsh-client-ui-commands/client'
// Type-only: pulls the ui-conversation SlotMap merge (the input.model seat).
import type {} from '@stackstackstack/dsh-client-ui-conversation/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@stackstackstack/dsh-client-locale/client'
import type { TranslateNS } from '@stackstackstack/dsh-client-ui-slots'
