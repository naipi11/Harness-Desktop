/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-settings-models`.
 * @module @stackstackstack/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-settings-models'
