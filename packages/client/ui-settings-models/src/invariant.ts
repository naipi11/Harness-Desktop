/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-settings-models`.
 * @module @harness-desktop/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-settings-models'
