/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-input-trigger`.
 * @module @stackstackstack/dsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-input-trigger'
