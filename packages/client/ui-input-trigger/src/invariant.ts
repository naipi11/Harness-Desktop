/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-input-trigger`.
 * @module @harness-desktop/dsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-input-trigger'
