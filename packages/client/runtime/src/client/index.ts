...
import type { ConnectionHandle, SessionId } from '@harness-desktop/dsh-api-remotes/client'
...
import type { TypertContext } from '@harness-desktop/dsh-typert-protocol'
import type { MaybeSnapshotSelectorHook, SnapshotSelectorHook } from '@harness-desktop/dsh-client-ui-slots'
...
export { isAppendSurfaceEvent, isReplacementSurfaceEvent } from '@harness-desktop/dsh-session/surface'
...
export type { SubagentAddress, JobView } from '@harness-desktop/dsh-client-connection/client'
...
export type { SessionId } from '@harness-desktop/dsh-client-connection/client'
