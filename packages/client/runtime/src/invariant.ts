/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-runtime`.
 * @module @harness-desktop/dsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@harness-desktop/dsh-client-ui-slots'
import type { InvariantInstaller } from '@harness-desktop/dsh-invariants'

const PACKAGE_NAME = '@harness-desktop/dsh-client-runtime'
