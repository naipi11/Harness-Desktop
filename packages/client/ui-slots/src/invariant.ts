/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-slots`.
 * @module @harness-desktop/dsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-slots'
