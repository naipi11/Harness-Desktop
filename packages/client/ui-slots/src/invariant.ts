/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-slots`.
 * @module @stackstackstack/dsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-slots'
