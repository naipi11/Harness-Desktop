/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-settings-general`.
 * @module @stackstackstack/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-settings-general'
