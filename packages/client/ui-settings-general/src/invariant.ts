/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-settings-general`.
 * @module @harness-desktop/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-settings-general'
