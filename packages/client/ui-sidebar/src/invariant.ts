/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-sidebar`.
 * @module @stackstackstack/dsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-sidebar'
