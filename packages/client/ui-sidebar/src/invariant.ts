/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-sidebar`.
 * @module @harness-desktop/dsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-sidebar'
