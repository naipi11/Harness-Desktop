/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-modules`.
 * @module @stackstackstack/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-modules'
