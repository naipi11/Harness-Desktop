/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-modules`.
 * @module @harness-desktop/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-modules'
