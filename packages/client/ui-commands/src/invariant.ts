/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-commands`.
 * @module @harness-desktop/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-commands'
