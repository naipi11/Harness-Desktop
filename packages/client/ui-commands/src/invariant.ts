/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-commands`.
 * @module @stackstackstack/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-commands'
