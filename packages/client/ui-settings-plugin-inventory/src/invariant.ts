/** Package-owned invariant companion. @module @stackstackstack/dsh-client-ui-settings-plugin-inventory/invariant */

/* jscpd:ignore-start */
import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@stackstackstack/dsh-invariants'

const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-settings-plugin-inventory'
