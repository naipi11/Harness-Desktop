...
const SNAPSHOT = {
  entries: [
    { entryId: '8a1b2c3d', moduleName: '@harness-desktop/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    ...
    { entryId: 'disabled-entry', moduleName: '@harness-desktop/dsh-host-directory-picker-native', enabled: false, fiberPhase: null },
  ],
