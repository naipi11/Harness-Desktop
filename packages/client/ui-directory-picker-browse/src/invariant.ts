/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-directory-picker-browse`.
 * @module @harness-desktop/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-directory-picker-browse'
