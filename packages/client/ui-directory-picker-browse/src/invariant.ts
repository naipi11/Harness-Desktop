/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-directory-picker-browse`.
 * @module @stackstackstack/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-directory-picker-browse'
