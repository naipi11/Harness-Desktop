 ...
 */
import type { ConnectionHandle } from '@harness-desktop/dsh-api-remotes/client'
...
import type {} from '@harness-desktop/dsh-client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@harness-desktop/dsh-api-remotes/client'
import type { ClientContext, SessionFace } from '@harness-desktop/dsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@harness-desktop/dsh-client-ui-commands/client'
import type { ClientSessionContext } from '@harness-desktop/dsh-client-ui-input-trigger/client'
import type { PermissionSelect } from '@harness-desktop/dsh-permission-presets/client'
