/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-permission-presets`.
 * @module @harness-desktop/dsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-permission-presets'
