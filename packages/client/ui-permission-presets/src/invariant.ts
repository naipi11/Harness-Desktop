/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-permission-presets`.
 * @module @stackstackstack/dsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-permission-presets'
