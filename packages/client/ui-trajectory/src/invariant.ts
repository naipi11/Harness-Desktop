/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-trajectory`.
 * @module @harness-desktop/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-trajectory'
