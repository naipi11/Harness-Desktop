/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-trajectory`.
 * @module @stackstackstack/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-trajectory'
