 ...
 * not built (`pnpm --filter @stackstackstack/dsh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@stackstackstack/dsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@stackstackstack/dsh-client-runtime/client', await import('@stackstackstack/dsh-client-runtime/client')],
      ['@stackstackstack/dsh-client-ui-primitives', await import('@stackstackstack/dsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@stackstackstack/dsh-client-locale/client')
