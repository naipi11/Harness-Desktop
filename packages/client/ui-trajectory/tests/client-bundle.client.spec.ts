 ...
 * not built (`pnpm --filter @harness-desktop/dsh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@harness-desktop/dsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@harness-desktop/dsh-client-runtime/client', await import('@harness-desktop/dsh-client-runtime/client')],
      ['@harness-desktop/dsh-client-ui-primitives', await import('@harness-desktop/dsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@harness-desktop/dsh-client-locale/client')
