...
import { resolveSlotLabel } from '@stackstackstack/dsh-client-ui-slots'
import {
  ConversationEventRegistry, ConversationViewRegistry, createSnapshotStore,
  EMPTY_CHAT_SNAPSHOT,
} from '@stackstackstack/dsh-client-runtime/client'
import { SlotRegistry } from '@stackstackstack/dsh-client-runtime/client'
import type {
  ConversationSnapshot, RequestView,
  SessionId, SessionListState, SnapshotStore, WorkspaceListState,
} from '@stackstackstack/dsh-client-runtime/client'
import type { ConvViewProps, ViewTab } from '@stackstackstack/dsh-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@stackstackstack/dsh-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@stackstackstack/dsh-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@stackstackstack/dsh-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@stackstackstack/dsh-client-locale/client'
import { stubSettingsScope } from '@stackstackstack/dsh-client-test-runtime'
import type { LocaleKeysOf } from '@stackstackstack/dsh-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@stackstackstack/dsh-client-ui-trajectory/client'
import { apply as nodeApply } from '@stackstackstack/dsh-client-ui-trajectory'
