...
import type { SnapshotStore } from '@harness-desktop/dsh-client-runtime/client'
import type { InjectFace, PropsLocale, PropsRuntime } from '@harness-desktop/dsh-client-ui-slots'
import { IconAgentPresetOutline16, IconChevronDownOutline14, Menu } from '@harness-desktop/dsh-client-ui-primitives'
// Type-only: pulls the ui-conversation SlotMap merge (the hero seat).
import type {} from '@harness-desktop/dsh-client-ui-conversation/client'
