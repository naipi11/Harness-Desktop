/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-agent-preset`.
 * @module @harness-desktop/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-agent-preset'
