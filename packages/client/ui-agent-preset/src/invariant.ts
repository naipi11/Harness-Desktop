/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-agent-preset`.
 * @module @stackstackstack/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-agent-preset'
