/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-message-feedback`.
 * @module @stackstackstack/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-message-feedback'
