/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-hmr`.
 * @module @stackstackstack/dsh-client-hmr/invariant
 */

import type { Context, Fiber } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@stackstackstack/dsh-invariants'

const PACKAGE_NAME = '@stackstackstack/dsh-client-hmr'
