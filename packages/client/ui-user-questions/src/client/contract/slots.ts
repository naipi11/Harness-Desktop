 ...
 * that consumes it.
 */
import type { PropsLocale, PropsRuntime } from '@harness-desktop/dsh-client-ui-slots'
...
import type { PendingWait } from '@harness-desktop/dsh-client-runtime/client'
import type { QuestionResponsePayload } from '@harness-desktop/dsh-api-remotes/client'
