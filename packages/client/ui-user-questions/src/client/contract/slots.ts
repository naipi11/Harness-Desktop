 ...
 * that consumes it.
 */
import type { PropsLocale, PropsRuntime } from '@stackstackstack/dsh-client-ui-slots'
...
import type { PendingWait } from '@stackstackstack/dsh-client-runtime/client'
import type { QuestionResponsePayload } from '@stackstackstack/dsh-api-remotes/client'
