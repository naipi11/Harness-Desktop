/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-user-questions`.
 * @module @stackstackstack/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-user-questions'
