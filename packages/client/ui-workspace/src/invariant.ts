/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-workspace`.
 * @module @harness-desktop/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-workspace'
