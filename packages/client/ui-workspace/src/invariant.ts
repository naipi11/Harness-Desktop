/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-workspace`.
 * @module @stackstackstack/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-workspace'
