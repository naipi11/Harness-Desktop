/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-conversation`.
 * @module @harness-desktop/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-conversation'
