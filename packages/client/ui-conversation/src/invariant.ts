/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-conversation`.
 * @module @stackstackstack/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-conversation'
