 ...
 * atoms' label props (`@stackstackstack/dsh-client-ui-attachment` reads no
...
} from '@stackstackstack/dsh-client-ui-attachment'
import type { ImageAttachmentLimits } from '@stackstackstack/dsh-attachment'
