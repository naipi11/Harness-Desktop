...
import { AttachmentRail, DropOverlay, ImageLightbox } from '@stackstackstack/dsh-client-ui-attachment'
import type { AttachmentRailItem } from '@stackstackstack/dsh-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@stackstackstack/dsh-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@stackstackstack/dsh-goal/client'
...
import type { Translate } from '@stackstackstack/dsh-client-ui-slots'
