...
} from '@harness-desktop/dsh-client-ui-primitives'
import { AttachmentRail, DropOverlay, ImageLightbox } from '@harness-desktop/dsh-client-ui-attachment'
import type { AttachmentRailItem } from '@harness-desktop/dsh-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@harness-desktop/dsh-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@harness-desktop/dsh-goal/client'
...
import type { Translate } from '@harness-desktop/dsh-client-ui-slots'
