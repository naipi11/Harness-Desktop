...
import type { ConversationTimelineSnapshot } from '@harness-desktop/dsh-client-runtime/client'
import { IconChevronDownOutline14 } from '@harness-desktop/dsh-client-ui-primitives'
