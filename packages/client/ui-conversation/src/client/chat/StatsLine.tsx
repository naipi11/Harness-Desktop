...
import { Tooltip } from '@harness-desktop/dsh-client-ui-primitives'
import type { ConversationSnapshot, UseProjection } from '@harness-desktop/dsh-client-runtime/client'
import type { SnapshotSelectorHook } from '@harness-desktop/dsh-client-ui-slots'
// Type-only: merges the sessionStats key into SessionProjectionMap for useProjection.
import type {} from '@harness-desktop/dsh-session-stats/client'
import type { ContextPressureProjection, TokenUsageProjection } from '@harness-desktop/dsh-token-meter/client'
