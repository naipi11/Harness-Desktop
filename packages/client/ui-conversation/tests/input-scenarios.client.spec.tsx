...
import type { ClientSessionContext, CommandClaim, PickOutcome, SubmitOutcome } from '@harness-desktop/dsh-client-ui-input-trigger/client'
...
import type { ConversationSnapshot } from '@harness-desktop/dsh-client-runtime/client'
