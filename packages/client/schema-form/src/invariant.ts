/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-schema-form`.
 * @module @harness-desktop/dsh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-schema-form'
