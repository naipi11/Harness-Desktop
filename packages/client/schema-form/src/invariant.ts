/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-schema-form`.
 * @module @stackstackstack/dsh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-schema-form'
