...
import type { GoalSnapshot } from '@harness-desktop/dsh-goal/client'
import {
...
import type { PropsLocale } from '@harness-desktop/dsh-client-ui-slots'
...
export type GoalDockProps = import('@harness-desktop/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
