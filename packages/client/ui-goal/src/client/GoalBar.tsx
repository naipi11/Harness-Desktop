...
import type { GoalSnapshot } from '@stackstackstack/dsh-goal/client'
import {
...
export type GoalDockProps = import('@stackstackstack/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
