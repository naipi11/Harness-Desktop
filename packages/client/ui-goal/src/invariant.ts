/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-goal`.
 * @module @stackstackstack/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-goal'
