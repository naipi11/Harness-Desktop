...
import { ConversationEventRegistry } from '@harness-desktop/dsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@harness-desktop/dsh-goal/client'
