...
import { ConversationEventRegistry } from '@stackstackstack/dsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@stackstackstack/dsh-goal/client'
