/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-layout`.
 * @module @harness-desktop/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-layout'
