/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-layout`.
 * @module @stackstackstack/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-layout'
