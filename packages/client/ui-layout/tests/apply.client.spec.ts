...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@harness-desktop/dsh-client-ui-theme/client'
import { apply, inject, LayoutController } from '@harness-desktop/dsh-client-ui-layout/client'
import { apply as nodeApply } from '@harness-desktop/dsh-client-ui-layout'
import * as invariant from '@harness-desktop/dsh-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@harness-desktop/dsh-client-ui-layout', expect.any(Function))
