...
import type { ChatFileMentions, TurnTailOwnerProps } from '@stackstackstack/dsh-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@stackstackstack/dsh-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@stackstackstack/dsh-client-ui-deliverables'])
