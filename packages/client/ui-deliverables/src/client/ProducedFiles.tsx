...
import type { HostDescriptionSource } from '@stackstackstack/dsh-client-connection/client'
import type { InjectFace, PropsLocale } from '@stackstackstack/dsh-client-ui-slots'
