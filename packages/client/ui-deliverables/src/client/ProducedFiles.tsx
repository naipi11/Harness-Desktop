...
import type { HostDescriptionSource } from '@harness-desktop/dsh-client-connection/client'
import type { InjectFace, PropsLocale } from '@harness-desktop/dsh-client-ui-slots'
