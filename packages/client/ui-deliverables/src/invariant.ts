/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-deliverables`.
 * @module @stackstackstack/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-deliverables'
