/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-deliverables`.
 * @module @harness-desktop/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-deliverables'
