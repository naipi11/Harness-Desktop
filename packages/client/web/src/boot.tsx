...
import * as ModulesClient from '@stackstackstack/dsh-client-modules/client'
import {
  ClientModuleSystem, parseBootManifest,
  type BootManifest, type ClientModuleSystemOptions, type DshWindow,
} from '@stackstackstack/dsh-client-modules/client'
 ...
 * twice.
 */
const MODULES_ID = '@stackstackstack/dsh-client-modules'
