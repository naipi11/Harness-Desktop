...
import * as UiSlots from '@stackstackstack/dsh-client-ui-slots'
import * as WebReact from '@stackstackstack/dsh-client-web-react'
import * as UiPrimitives from '@stackstackstack/dsh-client-ui-primitives'
import * as UiAttachment from '@stackstackstack/dsh-client-ui-attachment'
import * as SchemaForm from '@stackstackstack/dsh-client-schema-form'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@stackstackstack/dsh-client-ui-slots': UiSlots,
    '@stackstackstack/dsh-client-web-react': WebReact,
    '@stackstackstack/dsh-client-ui-primitives': UiPrimitives,
    '@stackstackstack/dsh-client-ui-attachment': UiAttachment,
    '@stackstackstack/dsh-client-schema-form': SchemaForm,
