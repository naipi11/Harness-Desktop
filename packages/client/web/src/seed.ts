...
import * as UiSlots from '@harness-desktop/dsh-client-ui-slots'
import * as WebReact from '@harness-desktop/dsh-client-web-react'
import * as UiPrimitives from '@harness-desktop/dsh-client-ui-primitives'
import * as UiAttachment from '@harness-desktop/dsh-client-ui-attachment'
import * as SchemaForm from '@harness-desktop/dsh-client-schema-form'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@harness-desktop/cordis': Cordis,
    '@harness-desktop/dsh-client-ui-slots': UiSlots,
    '@harness-desktop/dsh-client-web-react': WebReact,
    '@harness-desktop/dsh-client-ui-primitives': UiPrimitives,
    '@harness-desktop/dsh-client-ui-attachment': UiAttachment,
    '@harness-desktop/dsh-client-schema-form': SchemaForm,
