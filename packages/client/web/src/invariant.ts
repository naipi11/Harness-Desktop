/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-web`.
 * @module @stackstackstack/dsh-client-web/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-web'
