/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-tool`.
 * @module @harness-desktop/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-tool'
