/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-tool`.
 * @module @stackstackstack/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-tool'
