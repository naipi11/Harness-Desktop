...
import type { ToolCallBlock, ToolResultNode } from '@harness-desktop/dsh-client-runtime/client'

export type { ToolCallBlock } from '@harness-desktop/dsh-client-runtime/client'
