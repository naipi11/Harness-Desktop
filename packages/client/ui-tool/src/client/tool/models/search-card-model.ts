 ...
 * ({@link module:@harness-desktop/dsh-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@harness-desktop/dsh-client-ui-primitives'
