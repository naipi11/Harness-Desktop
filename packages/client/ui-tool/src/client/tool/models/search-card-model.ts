 ...
 * ({@link module:@stackstackstack/dsh-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@stackstackstack/dsh-client-ui-primitives'
