...
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@harness-desktop/dsh-client-ui-slots'
import type { ToolCallBlock } from '@harness-desktop/dsh-client-runtime/client'
