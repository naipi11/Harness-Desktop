...
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@stackstackstack/dsh-client-ui-slots'
import type { ToolCallBlock } from '@stackstackstack/dsh-client-runtime/client'
