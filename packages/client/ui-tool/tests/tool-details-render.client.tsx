...
import type { SessionProviderComponent, TranslateNS } from '@harness-desktop/dsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@harness-desktop/dsh-client-ui-conversation/src/client/contract/slots.ts'
