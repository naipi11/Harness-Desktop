...
import type { SessionProviderComponent, TranslateNS } from '@stackstackstack/dsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@stackstackstack/dsh-client-ui-conversation/src/client/contract/slots.ts'
