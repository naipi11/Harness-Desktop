/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-attachment`.
 * @module @stackstackstack/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-attachment'
