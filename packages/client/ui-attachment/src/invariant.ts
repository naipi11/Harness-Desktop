/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-attachment`.
 * @module @harness-desktop/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-attachment'
