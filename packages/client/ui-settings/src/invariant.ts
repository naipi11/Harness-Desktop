/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-settings`.
 * @module @stackstackstack/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-settings'
