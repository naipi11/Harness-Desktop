/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-settings`.
 * @module @harness-desktop/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-settings'
