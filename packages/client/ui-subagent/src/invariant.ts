/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-subagent`.
 * @module @harness-desktop/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-subagent'
