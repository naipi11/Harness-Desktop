/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-subagent`.
 * @module @stackstackstack/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-subagent'
