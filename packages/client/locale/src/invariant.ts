/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-locale`.
 * @module @harness-desktop/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-locale'
