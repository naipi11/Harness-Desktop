/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-locale`.
 * @module @stackstackstack/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-locale'
