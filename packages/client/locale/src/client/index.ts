...
import type { ClientContext, SettingsScope } from '@stackstackstack/dsh-client-runtime/client'
...
export type { Translate, TranslateNS } from '@stackstackstack/dsh-client-ui-slots'
