...
import type { ClientContext, SettingsScope } from '@harness-desktop/dsh-client-runtime/client'
...
export type { Translate, TranslateNS } from '@harness-desktop/dsh-client-ui-slots'
