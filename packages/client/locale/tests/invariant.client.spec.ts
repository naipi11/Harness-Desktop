...
import { apply as nodeApply } from '@harness-desktop/dsh-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@harness-desktop/dsh-client-locale/client'
import * as LocaleInvariant from '@harness-desktop/dsh-client-locale/invariant'
