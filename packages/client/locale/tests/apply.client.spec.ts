...
import { TestRemote } from '@stackstackstack/dsh-client-test-runtime'
import {
  apply, inject, SETTINGS_NS,
} from '@stackstackstack/dsh-client-locale/client'
import type { LanguageRowInjected, LocaleRuntime } from '@stackstackstack/dsh-client-locale/client'
