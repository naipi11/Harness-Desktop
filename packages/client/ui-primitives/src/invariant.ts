/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-primitives`.
 * @module @harness-desktop/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-primitives'
