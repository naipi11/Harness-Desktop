/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-primitives`.
 * @module @stackstackstack/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-primitives'
