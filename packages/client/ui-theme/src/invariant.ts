/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-theme`.
 * @module @harness-desktop/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-theme'
