/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-theme`.
 * @module @stackstackstack/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-theme'
