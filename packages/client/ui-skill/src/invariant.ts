/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-skill`.
 * @module @harness-desktop/dsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-skill'
