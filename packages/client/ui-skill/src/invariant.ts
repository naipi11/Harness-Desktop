/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-skill`.
 * @module @stackstackstack/dsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-skill'
