/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-connection`.
 * @module @stackstackstack/dsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-connection'
