/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-web-react`.
 * @module @stackstackstack/dsh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-web-react'
