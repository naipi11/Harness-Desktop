/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-web-react`.
 * @module @harness-desktop/dsh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-web-react'
