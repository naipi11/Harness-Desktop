/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-directory-picker-native`.
 * @module @stackstackstack/dsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-directory-picker-native'
