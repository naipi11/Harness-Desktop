/**
 * Package-owned invariant companion for `@stackstackstack/dsh-agent-loop-testkit`.
 * @module @stackstackstack/dsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-agent-loop-testkit'
