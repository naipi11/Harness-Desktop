/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-test-runtime`.
 * @module @harness-desktop/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-test-runtime'
