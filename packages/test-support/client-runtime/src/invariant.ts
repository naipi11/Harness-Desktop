/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-test-runtime`.
 * @module @stackstackstack/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-test-runtime'
