/**
 * Package-owned invariant companion for `@harness-desktop/dsh-llm-replay`.
 * @module @harness-desktop/dsh-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-llm-replay'
