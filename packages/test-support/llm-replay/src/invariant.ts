/**
 * Package-owned invariant companion for `@stackstackstack/dsh-llm-replay`.
 * @module @stackstackstack/dsh-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-llm-replay'
