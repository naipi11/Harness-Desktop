/**
 * Package-owned invariant companion for `@stackstackstack/dsh-llm-mock-server`.
 * @module @stackstackstack/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-llm-mock-server'
