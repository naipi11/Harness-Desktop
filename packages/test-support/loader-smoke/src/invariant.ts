/**
 * Package-owned invariant companion for `@harness-desktop/dsh-loader-smoke`.
 * @module @harness-desktop/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-loader-smoke'
