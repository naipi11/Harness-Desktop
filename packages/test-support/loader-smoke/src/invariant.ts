/**
 * Package-owned invariant companion for `@stackstackstack/dsh-loader-smoke`.
 * @module @stackstackstack/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-loader-smoke'
