/**
 * Package-owned invariant companion for `@harness-desktop/dsh-acp-snapshot`.
 * @module @harness-desktop/dsh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-acp-snapshot'
