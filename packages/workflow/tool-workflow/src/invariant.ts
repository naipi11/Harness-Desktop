/** Package-owned durable workflow-record invariants. @module @stackstackstack/dsh-tool-workflow/invariant */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-workflow'
