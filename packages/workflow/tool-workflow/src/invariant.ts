/** Package-owned durable workflow-record invariants. @module @harness-desktop/dsh-tool-workflow/invariant */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-workflow'
