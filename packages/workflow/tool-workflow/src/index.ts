 ...
 * (`@harness-desktop/dsh-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @harness-desktop/dsh-tool-workflow
 */
...
import type { ToolCallView, ToolResultView } from '@harness-desktop/dsh-tools'
import type { ContentBlock } from '@harness-desktop/dsh-llm'
import type { JsonValue, Session, SessionEventMap } from '@harness-desktop/dsh-session'
import type {
  WorkflowResult, WorkflowRun, WorkflowRunId, WorkflowStopReason,
} from '@harness-desktop/dsh-workflow'
import type {
