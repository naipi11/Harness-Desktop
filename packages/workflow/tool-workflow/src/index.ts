 ...
 * (`@stackstackstack/dsh-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @stackstackstack/dsh-tool-workflow
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { defineTool } from '@stackstackstack/dsh-tools'
import type { ToolCallView, ToolResultView } from '@stackstackstack/dsh-tools'
import type { ContentBlock } from '@stackstackstack/dsh-llm'
import type { JsonValue, Session, SessionEventMap } from '@stackstackstack/dsh-session'
import type {
