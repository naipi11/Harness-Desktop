 ...
 * @module @harness-desktop/dsh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@harness-desktop/dsh-llm'
import { SessionId } from '@harness-desktop/dsh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@harness-desktop/dsh-tools'
import type { ObjectJsonSchema } from '@harness-desktop/dsh-tools'
import { isFatalWorkflowError, WorkflowError } from '@harness-desktop/dsh-workflow'
import type {
