 ...
 * @module @stackstackstack/dsh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@stackstackstack/dsh-llm'
import { SessionId } from '@stackstackstack/dsh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@stackstackstack/dsh-tools'
import type { ObjectJsonSchema } from '@stackstackstack/dsh-tools'
import { isFatalWorkflowError, WorkflowError } from '@stackstackstack/dsh-workflow'
import type {
