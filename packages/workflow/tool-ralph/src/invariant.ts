/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-ralph`.
 * @module @stackstackstack/dsh-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-ralph'
