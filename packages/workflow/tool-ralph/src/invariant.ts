/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-ralph`.
 * @module @harness-desktop/dsh-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-ralph'
