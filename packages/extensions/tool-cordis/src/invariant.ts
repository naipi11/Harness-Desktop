/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-cordis`.
 * @module @harness-desktop/dsh-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-cordis'
