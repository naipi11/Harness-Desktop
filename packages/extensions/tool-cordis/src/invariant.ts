/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-cordis`.
 * @module @stackstackstack/dsh-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-cordis'
