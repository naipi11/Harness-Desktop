 ...
 * @module @stackstackstack/dsh-cordis-host-runner/guard
 */

import { Context } from '@deepseek-ai/cordis'
import type { Plugin } from '@deepseek-ai/cordis'
import { scopeOf } from '@stackstackstack/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@stackstackstack/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@stackstackstack/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
