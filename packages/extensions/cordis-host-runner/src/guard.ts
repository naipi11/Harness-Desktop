 ...
 * @module @harness-desktop/dsh-cordis-host-runner/guard
 */

import { Context } from '@harness-desktop/cordis'
import type { Plugin } from '@harness-desktop/cordis'
import { scopeOf } from '@harness-desktop/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@harness-desktop/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@harness-desktop/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
