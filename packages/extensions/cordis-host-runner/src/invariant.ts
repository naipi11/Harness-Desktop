/**
 * Package-owned invariant companion for `@stackstackstack/dsh-cordis-host-runner`.
 * @module @stackstackstack/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-cordis-host-runner'
