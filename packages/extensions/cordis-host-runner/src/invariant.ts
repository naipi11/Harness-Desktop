/**
 * Package-owned invariant companion for `@harness-desktop/dsh-cordis-host-runner`.
 * @module @harness-desktop/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-cordis-host-runner'
