...
import InvariantService from '@harness-desktop/dsh-invariants'
import type {
...
import type { DynamicCordisInvokeResult } from '@harness-desktop/dsh-api-remotes/client'
// Type-only: resolves `ctx.remote` and with it the `$on`/`$dispatch` surface.
import type {} from '@harness-desktop/dsh-api-gateway/client'
