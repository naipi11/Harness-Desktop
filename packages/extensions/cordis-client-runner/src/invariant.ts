/**
 * Package-owned invariant companion for `@harness-desktop/dsh-cordis-client-runner`.
 * @module @harness-desktop/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-cordis-client-runner'
