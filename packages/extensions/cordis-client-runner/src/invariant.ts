/**
 * Package-owned invariant companion for `@stackstackstack/dsh-cordis-client-runner`.
 * @module @stackstackstack/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-cordis-client-runner'
