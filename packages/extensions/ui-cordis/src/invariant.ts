/**
 * Package-owned invariant companion for `@stackstackstack/dsh-client-ui-cordis`.
 * @module @stackstackstack/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-client-ui-cordis'
