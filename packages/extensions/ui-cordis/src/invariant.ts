/**
 * Package-owned invariant companion for `@harness-desktop/dsh-client-ui-cordis`.
 * @module @harness-desktop/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-client-ui-cordis'
