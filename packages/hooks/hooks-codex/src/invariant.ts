/**
 * Package-owned invariant companion for `@stackstackstack/dsh-hooks-codex`.
 * @module @stackstackstack/dsh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-hooks-codex'
