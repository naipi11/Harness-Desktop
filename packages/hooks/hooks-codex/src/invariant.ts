/**
 * Package-owned invariant companion for `@harness-desktop/dsh-hooks-codex`.
 * @module @harness-desktop/dsh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-hooks-codex'
