...
import type { ShellExecRequest, ShellExecSpec, ShellExecutor, ShellRunResult } from '@harness-desktop/dsh-shell'
import { DEFAULT_HOOK_TIMEOUT_MS, runHook } from '@harness-desktop/dsh-hook-protocol'
import type { RunHookOptions } from '@harness-desktop/dsh-hook-protocol'
