/** Package-owned hook invocation/result stream invariants. @module @harness-desktop/dsh-hook-protocol/invariant */
...
const PACKAGE_NAME = '@harness-desktop/dsh-hook-protocol'
