/**
 * Package-owned invariant companion for `@stackstackstack/dsh-hooks-claude-code`.
 * @module @stackstackstack/dsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-hooks-claude-code'
