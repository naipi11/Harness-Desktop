/**
 * Package-owned invariant companion for `@harness-desktop/dsh-hooks-claude-code`.
 * @module @harness-desktop/dsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-hooks-claude-code'
