/**
 * Package-owned invariant companion for `@harness-desktop/dsh-command-feedback`.
 * @module @harness-desktop/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-command-feedback'
