...
import SessionStore, { foldSurface, Session, SessionId } from '@stackstackstack/dsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@stackstackstack/dsh-session-telemetry'
import * as commandFeedback from '@stackstackstack/dsh-command-feedback'
...
vi.mock('@stackstackstack/dsh-anonymous-user-id', () => ({
...
describe('@stackstackstack/dsh-command-feedback registration', () => {
