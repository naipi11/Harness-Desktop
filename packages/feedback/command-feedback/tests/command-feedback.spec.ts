...
import SessionStore, { foldSurface, Session, SessionId } from '@harness-desktop/dsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@harness-desktop/dsh-session-telemetry'
...
vi.mock('@harness-desktop/dsh-anonymous-user-id', () => ({
...
describe('@harness-desktop/dsh-command-feedback registration', () => {
