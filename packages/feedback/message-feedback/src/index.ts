 ...
 * @module @harness-desktop/dsh-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@harness-desktop/cordis'
import s from '@harness-desktop/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@harness-desktop/dsh-session/surface'
import type { SessionHeader, SessionId } from '@harness-desktop/dsh-session/types'
import type { SessionInspection } from '@harness-desktop/dsh-session-persistence'
import type { KvTable } from '@harness-desktop/dsh-storage-domain'
