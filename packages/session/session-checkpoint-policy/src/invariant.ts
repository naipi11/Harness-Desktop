/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-checkpoint-policy`.
 * @module @stackstackstack/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-checkpoint-policy'
