/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-checkpoint-policy`.
 * @module @harness-desktop/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-checkpoint-policy'
