/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-stats`.
 * @module @harness-desktop/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-stats'
