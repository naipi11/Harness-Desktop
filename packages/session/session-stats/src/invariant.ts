/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-stats`.
 * @module @stackstackstack/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-stats'
