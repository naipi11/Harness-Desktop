/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-title-all-prompts-llm`.
 * @module @harness-desktop/dsh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-title-all-prompts-llm'
