 ...
 * @module @harness-desktop/dsh-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@harness-desktop/cordis'
import z from '@harness-desktop/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@harness-desktop/dsh-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@harness-desktop/dsh-llm'
import type { GenerateOptions } from '@harness-desktop/dsh-llm'
import type {
  Session,
  SessionEvent,
