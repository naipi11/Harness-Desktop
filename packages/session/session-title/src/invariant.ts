/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-title`.
 * @module @harness-desktop/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-title'
