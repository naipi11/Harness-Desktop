/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-title`.
 * @module @stackstackstack/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-title'
