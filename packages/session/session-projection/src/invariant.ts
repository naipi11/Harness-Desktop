/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-projection`.
 * @module @stackstackstack/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-projection'
