/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-projection`.
 * @module @harness-desktop/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-projection'
