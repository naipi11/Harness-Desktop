/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-projection-cache`.
 * @module @stackstackstack/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-projection-cache'
