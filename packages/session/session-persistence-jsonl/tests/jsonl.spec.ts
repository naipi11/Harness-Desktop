import { MessageId, createUserMessage, createMessage } from '@harness-desktop/dsh-llm'
...
import type { Session, SessionEvent, SessionHeader } from '@harness-desktop/dsh-session'
