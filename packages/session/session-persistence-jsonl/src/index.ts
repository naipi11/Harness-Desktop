 ...
 * @module @harness-desktop/dsh-session-persistence-jsonl
 */
...
import type { SessionEvent, SessionId, SessionHeader, SessionPreparation } from '@harness-desktop/dsh-session'
import {
