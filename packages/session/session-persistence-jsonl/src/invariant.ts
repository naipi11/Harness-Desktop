/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-persistence-jsonl`.
 * @module @stackstackstack/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-persistence-jsonl'
