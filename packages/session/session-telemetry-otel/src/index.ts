 ...
 *
 * @module @stackstackstack/dsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@deepseek-ai/schemastery'
import type { Context } from '@deepseek-ai/cordis'
import type {} from '@stackstackstack/dsh-command-feedback'
import {
...
} from '@stackstackstack/dsh-session-telemetry'
import { APP_IDENTITY } from '@stackstackstack/dsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@stackstackstack/dsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@stackstackstack/dsh-session-telemetry-otel/ops', version)
