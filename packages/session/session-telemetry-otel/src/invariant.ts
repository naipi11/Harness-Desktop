/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-telemetry-otel`.
 * @module @stackstackstack/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-telemetry-otel'
