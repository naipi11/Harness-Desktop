/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-telemetry-otel`.
 * @module @harness-desktop/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-telemetry-otel'
