/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-persistence-sqlite`.
 * @module @stackstackstack/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-persistence-sqlite'
