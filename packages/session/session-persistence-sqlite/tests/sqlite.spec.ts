...
import type { Session, SessionEvent, SurfaceEvent, SurfaceEventType } from '@harness-desktop/dsh-session'
import SqliteSessionPersistence, { SCHEMA_VERSION } from '@harness-desktop/dsh-session-persistence-sqlite'
import {
  openDatabase,
  rowToEvent,
  rowToMeta,
