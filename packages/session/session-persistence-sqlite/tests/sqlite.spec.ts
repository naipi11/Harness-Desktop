...
import type { Session, SessionEvent, SurfaceEvent, SurfaceEventType } from '@stackstackstack/dsh-session'
import SqliteSessionPersistence, { SCHEMA_VERSION } from '@stackstackstack/dsh-session-persistence-sqlite'
import {
  openDatabase,
  rowToEvent,
  rowToMeta,
