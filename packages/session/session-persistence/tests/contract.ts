 ...
 *
 * @module @harness-desktop/dsh-session-persistence/tests/contract
 */

import { describe, expect, it } from 'vitest'
import { SESSION_FORMAT_VERSION, Session, SessionId, TOOL_NOT_STARTED, TOOL_OUTCOME_UNKNOWN } from '@harness-desktop/dsh-session'
import type { SessionEvent, SessionHeader, SurfaceEventType, SurfaceIntent } from '@harness-desktop/dsh-session'
import { CallId, MessageId, createMessage, freezeMessage } from '@harness-desktop/dsh-llm'
