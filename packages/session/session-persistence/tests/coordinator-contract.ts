 ...
 * @module @harness-desktop/dsh-session-persistence/tests/coordinator-contract
 */

import { describe, expect, it, vi } from 'vitest'
import { Context, type Fiber } from '@harness-desktop/cordis'
import { scopeTarget } from '@harness-desktop/dsh-scope'
import SessionStore, { SESSION_FORMAT_VERSION, Session, SessionId } from '@harness-desktop/dsh-session'
