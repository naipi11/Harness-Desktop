/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-persistence`.
 * @module @stackstackstack/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-persistence'
