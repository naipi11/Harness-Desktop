/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-persistence`.
 * @module @harness-desktop/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-persistence'
