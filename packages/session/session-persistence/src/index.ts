 ...
 * @module @harness-desktop/dsh-session-persistence
 */

import { Context, Service } from '@harness-desktop/cordis'
import { SessionPreparation } from '@harness-desktop/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@harness-desktop/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@harness-desktop/dsh-session'
