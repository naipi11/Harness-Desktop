/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-title-first-prompt-llm`.
 * @module @stackstackstack/dsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-title-first-prompt-llm'
