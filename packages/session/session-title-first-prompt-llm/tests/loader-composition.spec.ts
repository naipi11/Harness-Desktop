...
import * as providerPlugin from '@stackstackstack/dsh-session-title-first-prompt-llm'
...
async function loadComposition(): Promise<Context> {
  ...
  await writeFile(configPath, [
    ...
    "- name: '@stackstackstack/dsh-session-title'",
    '  config:',
    '    fallbackMaxWords: 5',
    '    fallbackMaxBytes: 40',
    '    maxTitleBytes: 80',
    "- name: '@stackstackstack/dsh-session-title-first-prompt-llm'",
    '  config:',
    '    targetWords: 5',
  ...
  const modules = new Map<string, unknown>([
    ['@stackstackstack/dsh-llm', LlmRuntime],
    ['@stackstackstack/dsh-session', SessionStore],
    ['@stackstackstack/dsh-session-title', SessionTitleService],
    ['@stackstackstack/dsh-session-title-first-prompt-llm', providerPlugin],
  ])
