/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-telemetry`.
 * @module @stackstackstack/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-telemetry'
