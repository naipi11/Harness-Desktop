/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-telemetry`.
 * @module @harness-desktop/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-telemetry'
