/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-title-llm`.
 * @module @harness-desktop/dsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-title-llm'
