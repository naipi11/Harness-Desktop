/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-title-llm`.
 * @module @stackstackstack/dsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-title-llm'
