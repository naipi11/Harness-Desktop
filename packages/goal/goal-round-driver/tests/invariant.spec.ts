...
import * as GoalSessionInvariant from '@harness-desktop/dsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@harness-desktop/dsh-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@harness-desktop/dsh-goal-round-driver',
    }))
  })
