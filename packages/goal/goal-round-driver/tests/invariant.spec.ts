...
import * as GoalSessionInvariant from '@stackstackstack/dsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@stackstackstack/dsh-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@stackstackstack/dsh-invariants'
import SessionStore, { SessionId, type Session } from '@stackstackstack/dsh-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@stackstackstack/dsh-goal-round-driver',
    }))
  })
