...
import { createUserMessage, HarnessError } from '@stackstackstack/dsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@stackstackstack/dsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@stackstackstack/dsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@stackstackstack/dsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@stackstackstack/dsh-session').SessionEvent[]): StubAgent {
