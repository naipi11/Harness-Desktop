...
import { createUserMessage, HarnessError } from '@harness-desktop/dsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@harness-desktop/dsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@harness-desktop/dsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@harness-desktop/dsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@harness-desktop/dsh-session').SessionEvent[]): StubAgent {
