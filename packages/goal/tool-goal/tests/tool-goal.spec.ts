...
import AgentRegistry, { agentEvents, Inbox } from '@harness-desktop/dsh-agent'
import type { Agent, AgentStatus } from '@harness-desktop/dsh-agent'
import GoalService, { GoalId } from '@harness-desktop/dsh-goal'
import type { GoalRef } from '@harness-desktop/dsh-goal'
import { createUserMessage, CallId } from '@harness-desktop/dsh-llm'
import type { MessageSource } from '@harness-desktop/dsh-llm'
