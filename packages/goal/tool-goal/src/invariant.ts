/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-goal`.
 * @module @harness-desktop/dsh-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-goal'
