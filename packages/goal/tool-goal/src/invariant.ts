/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-goal`.
 * @module @stackstackstack/dsh-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-goal'
