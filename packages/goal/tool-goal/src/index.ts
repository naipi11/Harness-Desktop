 ...
 * @module @stackstackstack/dsh-tool-goal
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { GoalId } from '@stackstackstack/dsh-goal'
import type { GoalRef, GoalView } from '@stackstackstack/dsh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@stackstackstack/dsh-llm'
import { defineTool } from '@stackstackstack/dsh-tools'
import type { GenericCallView } from '@stackstackstack/dsh-tools'
