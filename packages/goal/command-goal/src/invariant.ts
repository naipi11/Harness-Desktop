/**
 * Package-owned invariant companion for `@harness-desktop/dsh-command-goal`.
 * @module @harness-desktop/dsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-command-goal'
