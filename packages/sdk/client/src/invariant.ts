/**
 * Package-owned invariant companion for `@stackstackstack/dsh-sdk-client`.
 * @module @stackstackstack/dsh-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-sdk-client'
