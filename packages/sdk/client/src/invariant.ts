/**
 * Package-owned invariant companion for `@harness-desktop/dsh-sdk-client`.
 * @module @harness-desktop/dsh-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-sdk-client'
