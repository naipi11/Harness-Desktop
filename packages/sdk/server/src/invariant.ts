/**
 * Package-owned invariant companion for `@stackstackstack/dsh-sdk-jsonrpc-server`.
 * @module @stackstackstack/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-sdk-jsonrpc-server'
