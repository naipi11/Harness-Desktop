/**
 * Package-owned invariant companion for `@harness-desktop/dsh-sdk-jsonrpc-server`.
 * @module @harness-desktop/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-sdk-jsonrpc-server'
