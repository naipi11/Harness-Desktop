/**
 * Package-owned invariant companion for `@harness-desktop/dsh-sdk-protocol`.
 * @module @harness-desktop/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-sdk-protocol'
