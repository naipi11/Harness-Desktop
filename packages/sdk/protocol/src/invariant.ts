/**
 * Package-owned invariant companion for `@stackstackstack/dsh-sdk-protocol`.
 * @module @stackstackstack/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-sdk-protocol'
