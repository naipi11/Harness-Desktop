 ...
 * (`@stackstackstack/dsh-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@stackstackstack/dsh-sdk-client`, the Python SDK) drive it.
 *
 * @module @stackstackstack/dsh-sdk-protocol
 */
