/**
 * Package-owned invariant companion for `@harness-desktop/dsh-app-boot`.
 * @module @harness-desktop/dsh-app-boot/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-app-boot'
