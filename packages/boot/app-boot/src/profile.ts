...
const INSTALLATION_OWNED_PROFILE_TUPLES: Record<string, readonly string[]> = {
  headless: ['@stackstackstack/dsh-base', '@stackstackstack/dsh-web-app', '@stackstackstack/dsh-headless'],
}

/** The bundle list a `dsh plugin` init uses for a name with no shipped template. */
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@stackstackstack/dsh-base']
