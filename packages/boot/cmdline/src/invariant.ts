/**
 * Package-owned invariant companion for `@stackstackstack/dsh-cmdline`.
 * @module @stackstackstack/dsh-cmdline/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@stackstackstack/dsh-invariants'

const PACKAGE_NAME = '@stackstackstack/dsh-cmdline'
