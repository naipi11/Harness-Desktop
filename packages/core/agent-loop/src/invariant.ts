 ...
 * @module @harness-desktop/dsh-agent-loop/invariant
 */

import type { Context } from '@harness-desktop/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@harness-desktop/dsh-llm'
import type { InvariantFailure, InvariantInstaller } from '@harness-desktop/dsh-invariants'
import { foldRequestHeader } from '@harness-desktop/dsh-session'

const PACKAGE_NAME = '@harness-desktop/dsh-agent-loop'
