...
import { assertNever, createToolResultMessage, type ToolCallBlock } from '@harness-desktop/dsh-llm'
import type { Session, UserMessage } from '@harness-desktop/dsh-session'
import { TOOL_ABORTED_BEFORE_DISPATCH, TOOL_RUNTIME_SCHEDULER, type ToolExecutionInput, type ToolExecutionMode, type ToolExecutionResult, type ToolRunContext } from '@harness-desktop/dsh-tools'
