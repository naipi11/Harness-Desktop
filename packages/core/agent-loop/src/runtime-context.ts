 ...
 * @module @harness-desktop/dsh-agent-loop/runtime-context
 */

import { createUserMessage } from '@harness-desktop/dsh-llm'
import type { ContextSnapshotSection } from '@harness-desktop/dsh-llm'
import type { Session, UserMessage } from '@harness-desktop/dsh-session'
import { isReplacementSurfaceEvent } from '@harness-desktop/dsh-session'
