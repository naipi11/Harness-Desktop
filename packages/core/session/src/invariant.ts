 ...
 * companion beside `@stackstackstack/dsh-invariants` to enable the checks.
 *
 * @module @stackstackstack/dsh-session/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session'
