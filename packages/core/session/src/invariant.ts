 ...
 * companion beside `@harness-desktop/dsh-invariants` to enable the checks.
 *
 * @module @harness-desktop/dsh-session/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session'
