 ...
 *
 * @module @stackstackstack/dsh-session
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@stackstackstack/dsh-llm'
import { scopeOf, scopeTarget } from '@stackstackstack/dsh-scope'
import type { Scoped } from '@stackstackstack/dsh-scope'
import type { Message } from '@stackstackstack/dsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@stackstackstack/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@stackstackstack/dsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@stackstackstack/dsh-session#Session',
