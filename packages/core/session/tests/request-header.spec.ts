...
import { Session, SessionId, canonicalHeader, foldRequestHeader, headerEquals } from '@stackstackstack/dsh-session'
import type { EpochHeader, SessionEvent } from '@stackstackstack/dsh-session'
import { createUserMessage, ReasoningEffortId } from '@stackstackstack/dsh-llm'
