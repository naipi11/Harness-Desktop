 ...
 *
 * @module @stackstackstack/dsh-system-prompt
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@stackstackstack/dsh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@stackstackstack/dsh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@stackstackstack/dsh-llm'
...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@stackstackstack/dsh-scope`): scoped listeners
