...
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@stackstackstack/dsh-system-prompt'
import type { Config, PromptAssembly } from '@stackstackstack/dsh-system-prompt'
