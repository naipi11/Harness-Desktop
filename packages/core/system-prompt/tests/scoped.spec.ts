...
import { createScope, scopeOf } from '@harness-desktop/dsh-scope'
import type { Scope, ScopeKey } from '@harness-desktop/dsh-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@harness-desktop/dsh-system-prompt'
import type { Config, PromptAssembly } from '@harness-desktop/dsh-system-prompt'
