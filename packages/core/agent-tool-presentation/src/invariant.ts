/**
 * Package-owned invariant companion for `@harness-desktop/dsh-agent-tool-presentation`.
 * @module @harness-desktop/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-agent-tool-presentation'
