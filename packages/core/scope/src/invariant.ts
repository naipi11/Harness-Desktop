/** Package-owned scoped-dispatch invariants. @module @stackstackstack/dsh-scope/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@stackstackstack/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@stackstackstack/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@stackstackstack/dsh-scope'
