...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@harness-desktop/dsh-llm'
import SystemPrompt from '@harness-desktop/dsh-system-prompt'
import type { Agent } from '@harness-desktop/dsh-agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@harness-desktop/dsh-user-approval'
import ToolRuntime, {
