...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@stackstackstack/dsh-llm'
import SystemPrompt from '@stackstackstack/dsh-system-prompt'
import type { Agent } from '@stackstackstack/dsh-agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@stackstackstack/dsh-user-approval'
import ToolRuntime, {
