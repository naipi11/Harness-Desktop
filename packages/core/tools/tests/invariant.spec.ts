...
import type { ToolExecution, ToolExecutionResult, ToolExecutionToken } from '@stackstackstack/dsh-tools'
import * as ToolsInvariant from '@stackstackstack/dsh-tools/invariant'
