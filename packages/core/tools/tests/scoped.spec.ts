...
import { bindScopeParent, createScope } from '@stackstackstack/dsh-scope'
...
import type { PreToolDecision, ToolDefinition, ToolExecution, ToolExecutionInput, ToolExecutionToken } from '@stackstackstack/dsh-tools'
