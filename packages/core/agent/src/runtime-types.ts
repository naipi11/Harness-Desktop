 ...
 * turn/step boundaries remain `@harness-desktop/dsh-session` events.
 *
 * @module @harness-desktop/dsh-agent
 */

import type { Context } from '@harness-desktop/cordis'
import type { Scoped } from '@harness-desktop/dsh-scope'
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@harness-desktop/dsh-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@harness-desktop/dsh-session'
export type { AgentCancelCause } from '@harness-desktop/dsh-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@harness-desktop/dsh-system-prompt'
declare module '@harness-desktop/dsh-system-prompt' {
...
declare module '@harness-desktop/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@harness-desktop/dsh-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
