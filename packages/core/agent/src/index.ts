...
import { Context, FiberState, getTraceable, Service, symbols } from '@harness-desktop/cordis'
...
import type { TypertContext, TypertLookup } from '@harness-desktop/dsh-typert-protocol'
 ...
 * (`@harness-desktop/dsh-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@harness-desktop/dsh-agent#Agent',
