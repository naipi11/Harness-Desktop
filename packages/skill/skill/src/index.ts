 ...
 * Concrete
 * providers such as `@stackstackstack/dsh-skill-filesystem` decide where skills come
 ...
 *
 * @module @stackstackstack/dsh-skill
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { assertNever } from '@stackstackstack/dsh-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@stackstackstack/dsh-scope'
