/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-skill`.
 * @module @stackstackstack/dsh-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-skill'
