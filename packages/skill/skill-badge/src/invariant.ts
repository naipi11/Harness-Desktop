/**
 * Package-owned invariant companion for `@stackstackstack/dsh-skill-badge`.
 * @module @stackstackstack/dsh-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-skill-badge'
