/**
 * Package-owned invariant companion for `@harness-desktop/dsh-skill-badge`.
 * @module @harness-desktop/dsh-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-skill-badge'
