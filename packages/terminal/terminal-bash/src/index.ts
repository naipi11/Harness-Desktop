 ...
 * @module @harness-desktop/dsh-terminal-bash
 */
...
import { TerminalBackendCleanupError } from '@harness-desktop/dsh-terminal'
import type { TerminalBackend, TerminalBackendSpawnSpec } from '@harness-desktop/dsh-terminal'
import type { SubprocessTerminalHandle, SubprocessTerminalSpawnSpec } from '@harness-desktop/dsh-subprocess'
import type { SandboxExecutionPolicy } from '@harness-desktop/dsh-sandbox'
import { effectiveSandboxMode } from '@harness-desktop/dsh-sandbox-policy'
