/**
 * Package-owned invariant companion for `@stackstackstack/dsh-terminal-bash`.
 * @module @stackstackstack/dsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-terminal-bash'
