/**
 * Package-owned invariant companion for `@harness-desktop/dsh-terminal-bash`.
 * @module @harness-desktop/dsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-terminal-bash'
