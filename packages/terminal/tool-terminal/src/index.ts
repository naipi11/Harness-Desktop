 ...
 * @module @stackstackstack/dsh-tool-terminal
 */
...
import { TerminalSessionId } from '@stackstackstack/dsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@stackstackstack/dsh-terminal'
import type {} from '@stackstackstack/dsh-jobs'
import { defineTool } from '@stackstackstack/dsh-tools'
import type { ToolDefinition } from '@stackstackstack/dsh-tools'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @stackstackstack/dsh-jobs and @stackstackstack/dsh-tool-jobs')
