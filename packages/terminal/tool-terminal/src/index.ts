 ...
 * @module @harness-desktop/dsh-tool-terminal
 */
...
import { TerminalSessionId } from '@harness-desktop/dsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@harness-desktop/dsh-terminal'
import type {} from '@harness-desktop/dsh-jobs'
import { defineTool } from '@harness-desktop/dsh-tools'
import type { ToolDefinition } from '@harness-desktop/dsh-tools'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @harness-desktop/dsh-jobs and @harness-desktop/dsh-tool-jobs')
