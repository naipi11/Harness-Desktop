/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-terminal`.
 * @module @stackstackstack/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-terminal'
