/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-terminal`.
 * @module @harness-desktop/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-terminal'
