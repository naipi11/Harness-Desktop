/**
 * Package-owned invariant companion for `@stackstackstack/dsh-terminal`.
 * @module @stackstackstack/dsh-terminal/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-terminal'
