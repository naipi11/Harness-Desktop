/** Package-owned invariant companion for the subprocess seam. @module @stackstackstack/dsh-subprocess/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@stackstackstack/dsh-invariants'

const PACKAGE_NAME = '@stackstackstack/dsh-subprocess'
