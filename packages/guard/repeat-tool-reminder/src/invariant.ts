/**
 * Package-owned invariant companion for `@harness-desktop/dsh-repeat-tool-reminder`.
 * @module @harness-desktop/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-repeat-tool-reminder'
