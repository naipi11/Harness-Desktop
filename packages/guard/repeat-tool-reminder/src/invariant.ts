/**
 * Package-owned invariant companion for `@stackstackstack/dsh-repeat-tool-reminder`.
 * @module @stackstackstack/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-repeat-tool-reminder'
