/**
 * Unit + real-load-path coverage for @harness-desktop/dsh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@harness-desktop/dsh-llm'
import SystemPrompt from '@harness-desktop/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@harness-desktop/dsh-tools'
import * as timeoutPolicy from '@harness-desktop/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@harness-desktop/dsh-tool-call-timeout-policy'
