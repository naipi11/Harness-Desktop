/**
 * Unit + real-load-path coverage for @stackstackstack/dsh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@stackstackstack/dsh-llm'
import SystemPrompt from '@stackstackstack/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@stackstackstack/dsh-tools'
import * as timeoutPolicy from '@stackstackstack/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@stackstackstack/dsh-tool-call-timeout-policy'
