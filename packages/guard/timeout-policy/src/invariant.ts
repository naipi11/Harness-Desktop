/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-call-timeout-policy`.
 * @module @harness-desktop/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-call-timeout-policy'
