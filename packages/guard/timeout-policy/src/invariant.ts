/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-call-timeout-policy`.
 * @module @stackstackstack/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-call-timeout-policy'
