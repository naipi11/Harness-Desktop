 ...
 *
 * The seam itself lives in `@stackstackstack/dsh-compaction`, which re-exports these
 ...
 *
 * @module @stackstackstack/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@stackstackstack/dsh-llm/message'
