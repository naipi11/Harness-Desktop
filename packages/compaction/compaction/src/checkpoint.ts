 ...
 *
 * The seam itself lives in `@harness-desktop/dsh-compaction`, which re-exports these
 ...
 *
 * @module @harness-desktop/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@harness-desktop/dsh-llm/message'
