...
import { CommandId } from '@harness-desktop/dsh-commands/brand'
...
import * as CompactionInvariant from '@harness-desktop/dsh-compaction/invariant'
import * as CompactionBasicInvariant from '@harness-desktop/dsh-compaction-basic/invariant'
import { BasicCompactionEngine } from '@harness-desktop/dsh-compaction-basic'
import { CompactionId, isCompactCheckpointSource, ManualCompactionError } from '@harness-desktop/dsh-compaction'
...
import SessionStore, { Session, SessionId, type SessionEvent } from '@harness-desktop/dsh-session'
...
import type {
  SummarizationInput,
  SummaryResult,
} from '@harness-desktop/dsh-compaction-basic/src/summarizer.ts'
