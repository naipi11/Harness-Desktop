...
import { AttachmentId } from '@harness-desktop/dsh-attachment'
import BasicCompactionEngine from '@harness-desktop/dsh-compaction-basic'
import type { BasicCompactionConfig } from '@harness-desktop/dsh-compaction-basic'
import { selectCompactableRange } from '@harness-desktop/dsh-compaction-basic/src/region.ts'
import type { SummarizationInput, SummaryResult } from '@harness-desktop/dsh-compaction-basic/src/summarizer.ts'
import { CompactionId, toolPairingBalancedAfter, toolPairingBalancedBefore } from '@harness-desktop/dsh-compaction'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
} from '@harness-desktop/dsh-compaction-basic/src/config.ts'
import type { CompactionResult } from '@harness-desktop/dsh-compaction'
import LlmRuntime, { createUserMessage, CallId, CONTEXT_WINDOW_EXCEEDED_CODE, createToolResultMessage, LlmAdapter , createMessage } from '@harness-desktop/dsh-llm'
import type {
  ContentBlock,
  GenerateOptions,
  LlmFailure,
...
import SessionStore, { Session, SessionId } from '@harness-desktop/dsh-session'
import TokenMeter from '@harness-desktop/dsh-token-meter'
import { agentEvents, type Agent, type RequestErrorAction } from '@harness-desktop/dsh-agent'
import ToolResultPruner from '@harness-desktop/dsh-compaction-tool-result-pruner'
