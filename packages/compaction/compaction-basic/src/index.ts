...
import { CompactionEngine, ManualCompactionError } from '@stackstackstack/dsh-compaction'
import type { CompactionResult, CompactionTrigger } from '@stackstackstack/dsh-compaction'
import type { TokenMeter } from '@stackstackstack/dsh-token-meter'
import type { Session } from '@stackstackstack/dsh-session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from '@stackstackstack/dsh-llm'
...
import type {} from '@stackstackstack/dsh-compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
