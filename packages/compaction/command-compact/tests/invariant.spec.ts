...
import * as invariant from '@stackstackstack/dsh-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@stackstackstack/dsh-command-compact', expect.any(Function))
    expect(() => {
