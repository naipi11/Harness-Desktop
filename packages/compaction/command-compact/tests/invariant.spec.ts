...
import * as invariant from '@harness-desktop/dsh-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@harness-desktop/dsh-command-compact', expect.any(Function))
    expect(() => {
