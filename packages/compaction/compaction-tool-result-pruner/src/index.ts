 ...
 *
 * @module @harness-desktop/dsh-compaction-tool-result-pruner
 */

import { Context, Service } from '@harness-desktop/cordis'
import z from '@harness-desktop/schemastery'
import { freezeMessage } from '@harness-desktop/dsh-llm'
import type { ContentBlock } from '@harness-desktop/dsh-llm'
import type { Session, SessionEvent, ToolResultMessage } from '@harness-desktop/dsh-session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from '@harness-desktop/dsh-compaction'
