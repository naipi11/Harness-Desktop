/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-reference`.
 * @module @harness-desktop/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-reference'
