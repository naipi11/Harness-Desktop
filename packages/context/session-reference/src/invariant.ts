/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-reference`.
 * @module @stackstackstack/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-reference'
