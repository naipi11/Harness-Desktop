 ...
 *
 * @module @stackstackstack/dsh-session-reference
 */
...
import type { ContentBlock, UserMessage } from '@stackstackstack/dsh-llm'
import type { SessionId } from '@stackstackstack/dsh-session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@stackstackstack/dsh-session-query'
import {
