 ...
 *
 * @module @harness-desktop/dsh-session-reference
 */
...
import type { ContentBlock, UserMessage } from '@harness-desktop/dsh-llm'
import type { SessionId } from '@harness-desktop/dsh-session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@harness-desktop/dsh-session-query'
import {
