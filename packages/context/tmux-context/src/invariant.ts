/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tmux-context`.
 * @module @stackstackstack/dsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tmux-context'
