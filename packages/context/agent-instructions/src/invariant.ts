/**
 * Package-owned invariant companion for `@harness-desktop/dsh-agent-instructions`.
 * @module @harness-desktop/dsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-agent-instructions'
