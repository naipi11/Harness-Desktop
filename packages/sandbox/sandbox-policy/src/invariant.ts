/** Package-owned session-event invariants for sandbox policy. @module @harness-desktop/dsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@harness-desktop/dsh-sandbox-policy'
