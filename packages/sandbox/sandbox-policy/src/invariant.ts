/** Package-owned session-event invariants for sandbox policy. @module @stackstackstack/dsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@stackstackstack/dsh-sandbox-policy'
