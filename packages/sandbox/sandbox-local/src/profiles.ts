 ...
 *
 * @module @harness-desktop/dsh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@harness-desktop/node-addon-landlock-run'
 ...
 * (`@harness-desktop/dsh-fs-sandbox`) can never drift apart.
