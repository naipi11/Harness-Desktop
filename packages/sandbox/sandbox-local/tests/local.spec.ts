...
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@stackstackstack/dsh-sandbox'
import type { SandboxPolicy } from '@stackstackstack/dsh-sandbox'
import {
  LocalSandboxProvider,
} from '@stackstackstack/dsh-sandbox-local'
import type { Config } from '@stackstackstack/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @stackstackstack/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
