/**
 * Package-owned invariant companion for `@stackstackstack/dsh-sandbox-windows-acl`.
 * @module @stackstackstack/dsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-sandbox-windows-acl'
