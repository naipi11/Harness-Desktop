/**
 * Package-owned invariant companion for `@harness-desktop/dsh-sandbox-windows-acl`.
 * @module @harness-desktop/dsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-sandbox-windows-acl'
