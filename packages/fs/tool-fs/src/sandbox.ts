 ...
 * sequence to `@harness-desktop/dsh-sandbox` (the same pieces `@harness-desktop/dsh-tool-bash`
 ...
 *
 * @module @harness-desktop/dsh-tool-fs/sandbox
 */
...
import { ESCALATION_TARGETS, approveEscalation, escalationHintMarker, sandboxDenialMarker, validateEscalationArgs } from '@harness-desktop/dsh-sandbox'
