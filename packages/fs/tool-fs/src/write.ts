 ...
 * @module @stackstackstack/dsh-tool-fs/src/write
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@stackstackstack/dsh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@stackstackstack/dsh-tools'
import type { FsWriteOutcome } from '@stackstackstack/dsh-fs'
