/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-fs`.
 * @module @harness-desktop/dsh-tool-fs/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-fs'
