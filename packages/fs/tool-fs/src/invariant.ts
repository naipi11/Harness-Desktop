/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-fs`.
 * @module @stackstackstack/dsh-tool-fs/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-fs'
