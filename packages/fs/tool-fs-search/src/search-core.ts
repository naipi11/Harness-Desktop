 ...
 *
 * @module @stackstackstack/dsh-tool-fs-search/search-core
 */

import { isAbsolute, relative, sep } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import { HarnessError } from '@stackstackstack/dsh-llm'
import { ItemRetainer, TextRetainer } from '@stackstackstack/dsh-output-retention'
import type { RetainedItems } from '@stackstackstack/dsh-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@stackstackstack/dsh-subprocess'
import type { SaveTextSpill, SpillRef } from '@stackstackstack/dsh-spill'
 ...
 * `@stackstackstack/dsh-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@stackstackstack/dsh-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@stackstackstack/dsh-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@stackstackstack/dsh-tool-fs-search/presentation} `grepSearchMeta`)
