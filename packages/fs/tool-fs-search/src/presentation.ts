 ...
 * model-facing render consumes ({@link module:@stackstackstack/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @stackstackstack/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@stackstackstack/dsh-tool-fs-search/grep} `formatGrepMatches`), so
