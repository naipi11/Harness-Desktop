 ...
 * model-facing render consumes ({@link module:@harness-desktop/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @harness-desktop/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@harness-desktop/dsh-tool-fs-search/grep} `formatGrepMatches`), so
