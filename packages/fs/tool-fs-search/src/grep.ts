 ...
 *
 * @module @stackstackstack/dsh-tool-fs-search/grep
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@stackstackstack/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@stackstackstack/dsh-tools'
import type { RetainedItems } from '@stackstackstack/dsh-output-retention'
import type { SpillRef } from '@stackstackstack/dsh-spill'
