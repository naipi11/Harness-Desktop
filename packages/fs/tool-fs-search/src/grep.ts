 ...
 *
 * @module @harness-desktop/dsh-tool-fs-search/grep
 */

import type { Context } from '@harness-desktop/cordis'
import { defineTool } from '@harness-desktop/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@harness-desktop/dsh-tools'
import type { RetainedItems } from '@harness-desktop/dsh-output-retention'
import type { SpillRef } from '@harness-desktop/dsh-spill'
