/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-fs-search`.
 * @module @stackstackstack/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-fs-search'
