/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-fs-search`.
 * @module @harness-desktop/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-fs-search'
