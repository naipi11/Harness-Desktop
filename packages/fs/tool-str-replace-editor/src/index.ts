 ...
 * @module @harness-desktop/dsh-tool-str-replace-editor
 */
...
import type { FsInfo, FsTarget, FsWriteIntent } from '@harness-desktop/dsh-fs'
import { sandboxDenialMarker } from '@harness-desktop/dsh-sandbox'
import type { SandboxExecutionPolicy } from '@harness-desktop/dsh-sandbox'
import type { SandboxPolicyService } from '@harness-desktop/dsh-sandbox-policy'
import { defineTool } from '@harness-desktop/dsh-tools'
import type { ToolCallView, ToolRunContext } from '@harness-desktop/dsh-tools'
