/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-str-replace-editor`.
 * @module @harness-desktop/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-str-replace-editor'
