/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-str-replace-editor`.
 * @module @stackstackstack/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-str-replace-editor'
