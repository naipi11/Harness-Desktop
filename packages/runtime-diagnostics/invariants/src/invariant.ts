/**
 * Package-owned invariant companion for `@stackstackstack/dsh-invariants`.
 * @module @stackstackstack/dsh-invariants/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-invariants'
