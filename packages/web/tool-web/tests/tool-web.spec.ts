...
import type { WebSearchProvider, WebSearchResult } from '@stackstackstack/dsh-web'
...
} from '@stackstackstack/dsh-tool-web'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@stackstackstack/dsh-web').WebFetchProvider
