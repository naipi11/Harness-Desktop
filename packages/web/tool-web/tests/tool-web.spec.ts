...
import type { WebSearchProvider, WebSearchResult } from '@harness-desktop/dsh-web'
...
} from '@harness-desktop/dsh-tool-web'
import type { ContentBlock } from '@harness-desktop/dsh-llm'
import type { ToolResult } from '@harness-desktop/dsh-tools'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@harness-desktop/dsh-web').WebFetchProvider
