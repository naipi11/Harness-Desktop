...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@harness-desktop/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@harness-desktop/dsh-web'
 ...
 * `@harness-desktop/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@harness-desktop/dsh-tool-call-timeout-policy` to enforce.
