...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@stackstackstack/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@stackstackstack/dsh-web'
 ...
 * `@stackstackstack/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@stackstackstack/dsh-tool-call-timeout-policy` to enforce.
