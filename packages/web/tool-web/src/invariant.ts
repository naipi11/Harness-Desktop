/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-web`.
 * @module @stackstackstack/dsh-tool-web/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-web'
