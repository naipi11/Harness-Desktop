/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-web`.
 * @module @harness-desktop/dsh-tool-web/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-web'
