/**
 * `@stackstackstack/dsh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@stackstackstack/dsh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@stackstackstack/dsh-web`.
 *
 * @module @stackstackstack/dsh-web-search-exa
 */

import type { Context } from '@deepseek-ai/cordis'
import { launchEnvironmentOf } from '@stackstackstack/dsh-launch-environment'
import z from '@deepseek-ai/schemastery'
import type {} from '@stackstackstack/dsh-web'
import {
  ExaSearchProvider,
