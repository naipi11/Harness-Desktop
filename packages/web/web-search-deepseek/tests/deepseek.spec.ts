...
} from '@stackstackstack/dsh-web-search-deepseek'
...
import type { AnthropicResponse } from '@stackstackstack/dsh-web-search-deepseek/src/types.ts'

/** Construct the provider over a fixed options value; production passes a live thunk. */
import type { DeepSeekSearchProviderOptions } from '@stackstackstack/dsh-web-search-deepseek'
