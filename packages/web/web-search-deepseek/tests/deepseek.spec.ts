...
import LocalCredentialProvider from '@harness-desktop/dsh-credentials-local'
import WebRuntime from '@harness-desktop/dsh-web'
import {
  DeepSeekSearchProvider,
  DEEPSEEK_PROVIDER_ID,
} from '@harness-desktop/dsh-web-search-deepseek'
import * as deepseekPlugin from '@harness-desktop/dsh-web-search-deepseek'
import { citationSnippets, mapAnthropicResponse } from '../src/provider.ts'
import type { AnthropicResponse } from '@harness-desktop/dsh-web-search-deepseek/src/types.ts'

/** Construct the provider over a fixed options value; production passes a live thunk. */
import type { DeepSeekSearchProviderOptions } from '@harness-desktop/dsh-web-search-deepseek'
