/**
 * Package-owned invariant companion for `@stackstackstack/dsh-web-search-deepseek`.
 * @module @stackstackstack/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-web-search-deepseek'
