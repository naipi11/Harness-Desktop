/**
 * Package-owned invariant companion for `@harness-desktop/dsh-web-search-deepseek`.
 * @module @harness-desktop/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-web-search-deepseek'
