 ...
 * @module @harness-desktop/dsh-web-search-deepseek/provider
 */
...
import type {
  ...
  WebSearchResult,
  WebSearchSource,
} from '@harness-desktop/dsh-web'
import type { CredentialRef } from '@harness-desktop/dsh-credentials'
import type {} from '@harness-desktop/dsh-session'
import type {
  AnthropicError,
  AnthropicResponse,
  ContentBlock,
 ...
 * (`https://api.deepseek.com`) `@harness-desktop/dsh-llm-deepseek` uses, so this
