 ...
 * `@harness-desktop/dsh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @harness-desktop/dsh-web-fetch-http/provider
 */

import { WebError } from '@harness-desktop/dsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@harness-desktop/dsh-web'
