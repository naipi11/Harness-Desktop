 ...
 * `@stackstackstack/dsh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @stackstackstack/dsh-web-fetch-http/provider
 */

import { WebError } from '@stackstackstack/dsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@stackstackstack/dsh-web'
