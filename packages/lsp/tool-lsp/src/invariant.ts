/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-lsp`.
 * @module @stackstackstack/dsh-tool-lsp/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-lsp'
