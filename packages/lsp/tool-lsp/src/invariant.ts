/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-lsp`.
 * @module @harness-desktop/dsh-tool-lsp/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-lsp'
