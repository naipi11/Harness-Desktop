/**
 * Package-owned invariant companion for `@harness-desktop/dsh-lsp-stdio`.
 * @module @harness-desktop/dsh-lsp-stdio/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-lsp-stdio'
