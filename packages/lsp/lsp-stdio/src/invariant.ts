/**
 * Package-owned invariant companion for `@stackstackstack/dsh-lsp-stdio`.
 * @module @stackstackstack/dsh-lsp-stdio/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-lsp-stdio'
