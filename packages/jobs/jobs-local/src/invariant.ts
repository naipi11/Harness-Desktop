/**
 * Package-owned invariant companion for `@harness-desktop/dsh-jobs-local`.
 * @module @harness-desktop/dsh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-jobs-local'
...
/**
 * No runtime invariant: `@harness-desktop/dsh-jobs/invariant` owns per-snapshot identity, status,
