/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-jobs`.
 * @module @harness-desktop/dsh-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-jobs'
