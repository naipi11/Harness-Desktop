/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-jobs`.
 * @module @stackstackstack/dsh-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-jobs'
