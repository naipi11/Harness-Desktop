...
import AgentRegistry, { emitAgentEvent } from '@harness-desktop/dsh-agent'
...
import type { JobHooks, JobOutcome, JobSnapshot, JobStart } from '@harness-desktop/dsh-jobs'
import * as ToolTasks from '@harness-desktop/dsh-tool-jobs'
import { statusLine } from '@harness-desktop/dsh-tool-jobs'
