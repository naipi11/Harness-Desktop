/**
 * Package-owned invariant companion for `@stackstackstack/dsh-headless`.
 * @module @stackstackstack/dsh-headless/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@stackstackstack/dsh-invariants'

const PACKAGE_NAME = '@stackstackstack/dsh-headless'
