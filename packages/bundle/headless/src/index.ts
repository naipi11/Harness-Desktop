/**
 * @harness-desktop/dsh-headless — one-shot direct Agent driver. The bundle patch
 ...
 *
 * @module @harness-desktop/dsh-headless
 */
...
import type { ModelSelectionRef } from '@harness-desktop/dsh-agent'
import type {} from '@harness-desktop/dsh-agent-default-model'
...
import type {} from '@harness-desktop/dsh-cmdline'
