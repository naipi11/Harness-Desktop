/**
 * @stackstackstack/dsh-web-app — the browser-surface bundle's runtime glue plugin
 ...
 * @module @stackstackstack/dsh-web-app
 */
...
import { addHarnessSourceSection } from '@stackstackstack/dsh-app-boot'
import * as FrontendStatic from '@stackstackstack/dsh-host-frontend-static'
...
function resolveDistIndex(): string {
  ...
  try {
    return require.resolve('@stackstackstack/dsh-web-frontend/dist/index.html')
  } catch {
