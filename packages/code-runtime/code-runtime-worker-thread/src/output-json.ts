/** JSON string-prefix accounting for the outer-output ledger. @module @stackstackstack/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@stackstackstack/dsh-code-runtime'
