/** JSON string-prefix accounting for the outer-output ledger. @module @harness-desktop/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@harness-desktop/dsh-code-runtime'
