/**
 * Package-owned invariant companion for `@harness-desktop/dsh-code-runtime-worker-thread`.
 * @module @harness-desktop/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-code-runtime-worker-thread'
