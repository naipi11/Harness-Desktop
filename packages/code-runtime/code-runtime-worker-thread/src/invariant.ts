/**
 * Package-owned invariant companion for `@stackstackstack/dsh-code-runtime-worker-thread`.
 * @module @stackstackstack/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-code-runtime-worker-thread'
