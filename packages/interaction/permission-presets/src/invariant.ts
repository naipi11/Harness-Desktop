/** Package-owned permission-preset event invariants. @module @harness-desktop/dsh-permission-presets/invariant */
...
const PACKAGE_NAME = '@harness-desktop/dsh-permission-presets'
