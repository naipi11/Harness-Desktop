/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-ask-user`.
 * @module @stackstackstack/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-ask-user'
