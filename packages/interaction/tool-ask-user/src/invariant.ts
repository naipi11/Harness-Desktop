/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-ask-user`.
 * @module @harness-desktop/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-ask-user'
