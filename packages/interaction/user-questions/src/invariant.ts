/**
 * Package-owned invariant companion for `@harness-desktop/dsh-user-questions`.
 * @module @harness-desktop/dsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-user-questions'
