/**
 * Package-owned invariant companion for `@stackstackstack/dsh-user-questions`.
 * @module @stackstackstack/dsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-user-questions'
