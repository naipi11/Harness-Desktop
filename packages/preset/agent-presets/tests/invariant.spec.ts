...
import AgentRegistry, { assembleContextFor } from '@stackstackstack/dsh-agent'
import AgentLoop from '@stackstackstack/dsh-agent-loop'
import InvariantRegistry from '@stackstackstack/dsh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@stackstackstack/dsh-agent-presets'
import * as AgentPresetsInvariant from '@stackstackstack/dsh-agent-presets/invariant'
