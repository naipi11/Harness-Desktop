 ...
 * @module @stackstackstack/dsh-agent-presets/mount
 */
...
import { scopeOf, scopeParentOf, type ScopeKey } from '@stackstackstack/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@stackstackstack/dsh-*` row would fail to import. The
