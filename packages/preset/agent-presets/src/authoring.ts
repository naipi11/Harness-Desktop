 ...
 * @module @stackstackstack/dsh-agent-presets/authoring
 */

import { chmod, cp, readdir, readFile, rm, stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, resolve } from 'node:path'
import { writeFileAtomic } from '@stackstackstack/dsh-atomic-write'
import { expandHomePath } from '@stackstackstack/dsh-home-paths'
