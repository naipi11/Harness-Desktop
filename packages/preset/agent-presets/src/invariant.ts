/**
 * Package-owned invariant companion for `@stackstackstack/dsh-agent-presets`.
 * @module @stackstackstack/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@stackstackstack/dsh-agent-presets'

const PACKAGE_NAME = '@stackstackstack/dsh-agent-presets'
