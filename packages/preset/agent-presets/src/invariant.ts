/**
 * Package-owned invariant companion for `@harness-desktop/dsh-agent-presets`.
 * @module @harness-desktop/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@harness-desktop/dsh-agent-presets'

const PACKAGE_NAME = '@harness-desktop/dsh-agent-presets'
