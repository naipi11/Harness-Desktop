/**
 * Package-owned invariant companion for `@harness-desktop/dsh-persona`.
 * @module @harness-desktop/dsh-persona/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-persona'
