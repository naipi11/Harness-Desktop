...
import type { TypertForwardableEvent } from '@harness-desktop/dsh-typert-protocol'
...
// event vocabulary.
import type {} from '@harness-desktop/dsh-commands/types'
import type {} from '@harness-desktop/dsh-cordis-host-runner/types'
import type {} from '@harness-desktop/dsh-credentials/types'
import type {} from '@harness-desktop/dsh-llm/types'
import type {} from '@harness-desktop/dsh-agent-presets/types'
import type {} from '@harness-desktop/dsh-settings/types'
