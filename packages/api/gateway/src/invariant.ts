/**
 * Package-owned invariant companion for `@harness-desktop/dsh-api-gateway`.
 * @module @harness-desktop/dsh-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-api-gateway'
