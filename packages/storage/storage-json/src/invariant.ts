/**
 * Package-owned invariant companion for `@harness-desktop/dsh-storage-json`.
 * @module @harness-desktop/dsh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-storage-json'
