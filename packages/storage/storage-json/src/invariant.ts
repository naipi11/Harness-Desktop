/**
 * Package-owned invariant companion for `@stackstackstack/dsh-storage-json`.
 * @module @stackstackstack/dsh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-storage-json'
