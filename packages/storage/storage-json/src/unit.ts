 ...
 * @module @stackstackstack/dsh-storage-json/src/unit
 */

import { readFile } from 'node:fs/promises'
import { StorageError } from '@stackstackstack/dsh-storage'
import type { KvUnit, KvUnitDescriptor } from '@stackstackstack/dsh-storage'
