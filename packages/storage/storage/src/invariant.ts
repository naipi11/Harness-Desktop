/**
 * Package-owned invariant companion for `@stackstackstack/dsh-storage`.
 * @module @stackstackstack/dsh-storage/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-storage'
