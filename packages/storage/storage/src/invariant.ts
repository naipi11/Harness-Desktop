/**
 * Package-owned invariant companion for `@harness-desktop/dsh-storage`.
 * @module @harness-desktop/dsh-storage/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-storage'
