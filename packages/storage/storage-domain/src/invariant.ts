/**
 * Package-owned invariant companion for `@stackstackstack/dsh-storage-domain`: every
 ...
 * @module @stackstackstack/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-storage-domain'
