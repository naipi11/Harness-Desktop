/**
 * Package-owned invariant companion for `@harness-desktop/dsh-storage-domain`: every
 ...
 * @module @harness-desktop/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-storage-domain'
