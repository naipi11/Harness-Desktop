/**
 * Package-owned invariant companion for `@stackstackstack/dsh-storage-sqlite`.
 * @module @stackstackstack/dsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-storage-sqlite'
