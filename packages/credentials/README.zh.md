...
| [`credentials-local/`](credentials-local/README.md) | 环境与本地文件提供方；Runtime 基础组合不再挂载它 | 注册 `ctx.credentials` |
| [`credentials-platform/`](credentials-platform/README.md) | 平台/环境提供方（Runtime） | 注册 `ctx.credentials` |
