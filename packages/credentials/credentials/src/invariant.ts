/**
 * Package-owned invariant companion for `@harness-desktop/dsh-credentials`.
 * @module @harness-desktop/dsh-credentials/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-credentials'
