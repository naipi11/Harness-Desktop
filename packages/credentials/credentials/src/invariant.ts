/**
 * Package-owned invariant companion for `@stackstackstack/dsh-credentials`.
 * @module @stackstackstack/dsh-credentials/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantFailure, InvariantInstaller } from '@stackstackstack/dsh-invariants'

const PACKAGE_NAME = '@stackstackstack/dsh-credentials'
