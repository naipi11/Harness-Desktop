/**
 * Package-owned invariant companion for `@harness-desktop/dsh-credentials-local`.
 * @module @harness-desktop/dsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-credentials-local'
