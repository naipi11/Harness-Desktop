...
import type { ToolDefinition, ToolExecution } from '@harness-desktop/dsh-tools'
import { assertSupportedJsonSchema } from '@harness-desktop/dsh-tools'
import type { JsonSchemaNode, JsonValue } from '@harness-desktop/dsh-tools'
