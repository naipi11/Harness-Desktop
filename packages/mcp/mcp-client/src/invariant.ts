/**
 * Package-owned invariant companion for `@harness-desktop/dsh-mcp-client`.
 * @module @harness-desktop/dsh-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-mcp-client'
