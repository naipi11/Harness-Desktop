/**
 * Package-owned invariant companion for `@stackstackstack/dsh-mcp-client`.
 * @module @stackstackstack/dsh-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-mcp-client'
