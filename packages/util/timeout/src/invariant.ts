/**
 * Package-owned invariant companion for `@harness-desktop/dsh-timeout`.
 * @module @harness-desktop/dsh-timeout/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-timeout'
