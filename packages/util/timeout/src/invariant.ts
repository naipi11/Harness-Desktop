/**
 * Package-owned invariant companion for `@stackstackstack/dsh-timeout`.
 * @module @stackstackstack/dsh-timeout/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-timeout'
