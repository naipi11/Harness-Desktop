/**
 * Package-owned invariant companion for `@harness-desktop/dsh-output-retention`.
 * @module @harness-desktop/dsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-output-retention'
