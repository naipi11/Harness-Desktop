/**
 * Package-owned invariant companion for `@stackstackstack/dsh-output-retention`.
 * @module @stackstackstack/dsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-output-retention'
