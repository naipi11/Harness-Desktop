/**
 * Package-owned invariant companion for `@harness-desktop/dsh-launch-environment`.
 * @module @harness-desktop/dsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-launch-environment'
