/**
 * Package-owned invariant companion for `@stackstackstack/dsh-launch-environment`.
 * @module @stackstackstack/dsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-launch-environment'
