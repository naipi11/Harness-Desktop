/**
 * Package-owned invariant companion for `@stackstackstack/dsh-atomic-write`.
 * @module @stackstackstack/dsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-atomic-write'
