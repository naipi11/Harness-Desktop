/**
 * Package-owned invariant companion for `@harness-desktop/dsh-home-paths`.
 * @module @harness-desktop/dsh-home-paths/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-home-paths'
