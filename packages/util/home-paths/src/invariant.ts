/**
 * Package-owned invariant companion for `@stackstackstack/dsh-home-paths`.
 * @module @stackstackstack/dsh-home-paths/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-home-paths'
