/**
 * Package-owned invariant companion for `@harness-desktop/dsh-native-command`.
 * @module @harness-desktop/dsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-native-command'
