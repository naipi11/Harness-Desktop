/**
 * Package-owned invariant companion for `@stackstackstack/dsh-native-command`.
 * @module @stackstackstack/dsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-native-command'
