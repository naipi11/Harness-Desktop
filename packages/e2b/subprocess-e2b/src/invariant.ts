/**
 * Package-owned invariant companion for `@harness-desktop/dsh-subprocess-e2b`.
 * @module @harness-desktop/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-subprocess-e2b'
