/**
 * Package-owned invariant companion for `@stackstackstack/dsh-subprocess-e2b`.
 * @module @stackstackstack/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-subprocess-e2b'
