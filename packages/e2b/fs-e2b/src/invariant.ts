/**
 * Package-owned invariant companion for `@harness-desktop/dsh-fs-e2b`.
 * @module @harness-desktop/dsh-fs-e2b/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-fs-e2b'
