/**
 * Package-owned invariant companion for `@stackstackstack/dsh-fs-e2b`.
 * @module @stackstackstack/dsh-fs-e2b/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-fs-e2b'
