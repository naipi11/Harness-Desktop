/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-subagent`.
 * @module @harness-desktop/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-subagent'
