/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-subagent`.
 * @module @stackstackstack/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-subagent'
