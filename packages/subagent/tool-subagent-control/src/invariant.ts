/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-subagent-control`.
 * @module @stackstackstack/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-subagent-control'
