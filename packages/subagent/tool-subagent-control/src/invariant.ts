/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-subagent-control`.
 * @module @harness-desktop/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-subagent-control'
