 ...
 * @module @stackstackstack/dsh-tool-subagent-control/list-agents
 */
...
import type { SubagentDescendantListEntry, SubagentListEntry } from '@stackstackstack/dsh-subagent'
