 ...
 * runtime over stdio JSON-RPC through `@stackstackstack/dsh-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@stackstackstack/dsh-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @stackstackstack/dsh-subagent-dsh-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { DeepSeekHarness, type HarnessNotification } from '@stackstackstack/dsh-sdk-client'
import type { ContentBlock } from '@stackstackstack/dsh-llm'
import { SessionId, type SessionEvent, type TurnEndReason } from '@stackstackstack/dsh-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@stackstackstack/dsh-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@stackstackstack/dsh-subagent'
import { scrubbedParentEnv } from '@stackstackstack/dsh-subprocess'
