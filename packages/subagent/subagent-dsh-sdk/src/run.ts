 ...
 * runtime over stdio JSON-RPC through `@harness-desktop/dsh-sdk-client` and owns
 * cancellation and quiescent disposal. Structure mirrors the ACP backend
 * (`@harness-desktop/dsh-subagent-acp`): publish after the child handshake,
 ...
 *
 * @module @harness-desktop/dsh-subagent-dsh-sdk/run
 */

import { randomUUID } from 'node:crypto'
import { DeepSeekHarness, type HarnessNotification } from '@harness-desktop/dsh-sdk-client'
import type { ContentBlock } from '@harness-desktop/dsh-llm'
import { SessionId, type SessionEvent, type TurnEndReason } from '@harness-desktop/dsh-session'
import type { SubagentResult, SubagentRun, SubagentStartRequest, SubagentStopReason } from '@harness-desktop/dsh-subagent'
import { AssistantOutputFold, settleRunResult, subprocessRunHandle } from '@harness-desktop/dsh-subagent'
