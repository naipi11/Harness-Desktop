/**
 * Package-owned invariant companion for `@harness-desktop/dsh-subagent-dsh-sdk`.
 * @module @harness-desktop/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-subagent-dsh-sdk'
