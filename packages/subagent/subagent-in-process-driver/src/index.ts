 ...
 * one result.
 *
 * @module @stackstackstack/dsh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@deepseek-ai/cordis'
import { foldConsumedWork } from '@stackstackstack/dsh-agent'
...
import { createUserMessage, type ContentBlock } from '@stackstackstack/dsh-llm'
import {
