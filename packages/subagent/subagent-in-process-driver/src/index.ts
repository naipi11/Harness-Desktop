 ...
 * one result.
 *
 * @module @harness-desktop/dsh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@harness-desktop/cordis'
import { foldConsumedWork } from '@harness-desktop/dsh-agent'
...
import { createUserMessage, type ContentBlock } from '@harness-desktop/dsh-llm'
import {
