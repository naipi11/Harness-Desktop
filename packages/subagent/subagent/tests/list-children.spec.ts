...
import type { SessionEvent, SessionHeader } from '@stackstackstack/dsh-session'
...
import SessionProjectionCache from '@stackstackstack/dsh-session-projection-cache'
