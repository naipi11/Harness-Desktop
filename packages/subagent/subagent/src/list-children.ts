...
import type { SessionProjectionRegistry } from '@stackstackstack/dsh-session-projection'
import type { SessionProjectionCache } from '@stackstackstack/dsh-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @stackstackstack/dsh-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @stackstackstack/dsh-session)',
