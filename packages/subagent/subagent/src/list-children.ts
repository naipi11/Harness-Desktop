...
import type { Session, SessionEvent, SessionHeader, SessionId } from '@harness-desktop/dsh-session'
import type { SessionPersistence } from '@harness-desktop/dsh-session-persistence'
import type { SessionProjectionRegistry } from '@harness-desktop/dsh-session-projection'
import type { SessionProjectionCache } from '@harness-desktop/dsh-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @harness-desktop/dsh-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @harness-desktop/dsh-session)',
