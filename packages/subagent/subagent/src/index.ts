 ...
 * (`@stackstackstack/dsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@stackstackstack/dsh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@stackstackstack/dsh-tools'
import type { ContentBlock, MessageId } from '@stackstackstack/dsh-llm'
