 ...
 *
 * @module @harness-desktop/dsh-subagent/types
 */

import type { Agent, AgentOptions } from '@harness-desktop/dsh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@harness-desktop/dsh-tools'
