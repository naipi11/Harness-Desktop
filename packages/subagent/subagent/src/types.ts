 ...
 *
 * @module @stackstackstack/dsh-subagent/types
 */

import type { Agent, AgentOptions } from '@stackstackstack/dsh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@stackstackstack/dsh-tools'
