/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-subagent-report`.
 * @module @harness-desktop/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-subagent-report'
