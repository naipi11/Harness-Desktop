/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-subagent-report`.
 * @module @stackstackstack/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-subagent-report'
