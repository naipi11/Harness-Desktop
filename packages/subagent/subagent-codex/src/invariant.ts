/**
 * Package-owned invariant companion for `@stackstackstack/dsh-subagent-codex`.
 * @module @stackstackstack/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-subagent-codex'
