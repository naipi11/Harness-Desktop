/**
 * Package-owned invariant companion for `@harness-desktop/dsh-subagent-codex`.
 * @module @harness-desktop/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-subagent-codex'
