 ...
 *
 * @module @stackstackstack/dsh-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@stackstackstack/dsh-llm'
import type { SubagentResult } from '@stackstackstack/dsh-subagent'
import { JsonRpcLineTransport } from '@stackstackstack/dsh-sdk-protocol'
