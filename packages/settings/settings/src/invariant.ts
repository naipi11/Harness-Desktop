/**
 * Package-owned invariant companion for `@stackstackstack/dsh-settings`.
 * @module @stackstackstack/dsh-settings/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-settings'
