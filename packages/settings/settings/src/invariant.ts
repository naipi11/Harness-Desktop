/**
 * Package-owned invariant companion for `@harness-desktop/dsh-settings`.
 * @module @harness-desktop/dsh-settings/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-settings'
