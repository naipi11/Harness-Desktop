/**
 * Package-owned invariant companion for `@harness-desktop/dsh-settings-file`.
 * @module @harness-desktop/dsh-settings-file/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@harness-desktop/dsh-settings`.
 */
