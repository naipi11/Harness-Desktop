/**
 * Package-owned invariant companion for `@stackstackstack/dsh-typert-generator`.
 * @module @stackstackstack/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-typert-generator'
