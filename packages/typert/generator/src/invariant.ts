/**
 * Package-owned invariant companion for `@harness-desktop/dsh-typert-generator`.
 * @module @harness-desktop/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-typert-generator'
