/**
 * Package-owned invariant companion for `@stackstackstack/dsh-typert-protocol`.
 * @module @stackstackstack/dsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-typert-protocol'
