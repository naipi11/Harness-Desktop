/**
 * Package-owned invariant companion for `@stackstackstack/dsh-typert-loader`.
 * @module @stackstackstack/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-typert-loader'
