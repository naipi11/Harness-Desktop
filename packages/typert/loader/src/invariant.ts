/**
 * Package-owned invariant companion for `@harness-desktop/dsh-typert-loader`.
 * @module @harness-desktop/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-typert-loader'
