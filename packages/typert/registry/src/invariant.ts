/**
 * Package-owned invariant companion for `@stackstackstack/dsh-typert-registry`.
 * @module @stackstackstack/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-typert-registry'
