/**
 * Package-owned invariant companion for `@harness-desktop/dsh-typert-registry`.
 * @module @harness-desktop/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-typert-registry'
