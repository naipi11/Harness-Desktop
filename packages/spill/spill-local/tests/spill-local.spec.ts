...
import type { SaveTextSpill } from '@stackstackstack/dsh-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@stackstackstack/dsh-spill-local'
