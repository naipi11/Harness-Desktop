...
import { bwrapProfileArgs } from '@stackstackstack/dsh-sandbox-local/src/profiles.ts'
 ...
 * backend-only confinement is covered by `@stackstackstack/dsh-sandbox-local`.
 *
