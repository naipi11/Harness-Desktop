 ...
 *
 * @module @harness-desktop/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@harness-desktop/dsh-shell'
import type { SandboxMode } from '@harness-desktop/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@harness-desktop/dsh-sandbox'
 ...
 * rendering story, owned by `@harness-desktop/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@harness-desktop/dsh-shell'
