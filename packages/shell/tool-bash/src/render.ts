 ...
 *
 * @module @stackstackstack/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@stackstackstack/dsh-shell'
import type { SandboxMode } from '@stackstackstack/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@stackstackstack/dsh-sandbox'
 ...
 * rendering story, owned by `@stackstackstack/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@stackstackstack/dsh-shell'
