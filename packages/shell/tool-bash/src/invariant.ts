/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-bash`.
 * @module @stackstackstack/dsh-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-bash'
