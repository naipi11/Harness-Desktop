/**
 * Package-owned invariant companion for `@harness-desktop/dsh-tool-bash`.
 * @module @harness-desktop/dsh-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-tool-bash'
