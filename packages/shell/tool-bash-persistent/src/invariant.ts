/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-bash-persistent`.
 * @module @stackstackstack/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-bash-persistent'
