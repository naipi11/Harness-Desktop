 ...
 *
 * @module @harness-desktop/dsh-pwsh-local
 */
...
import { SHELL_SETTINGS_NAMESPACE, ShellExecutor } from '@harness-desktop/dsh-shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@harness-desktop/dsh-shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@harness-desktop/dsh-subprocess'
import { installSettingsSection } from '@harness-desktop/dsh-settings'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@harness-desktop/dsh-timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@harness-desktop/dsh-pwsh-sandbox`.
