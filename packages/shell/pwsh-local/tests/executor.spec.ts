/**
 * Real-process tests for `@stackstackstack/dsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@stackstackstack/dsh-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@stackstackstack/dsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@stackstackstack/dsh-timeout'
import type { ShellProcess } from '@stackstackstack/dsh-shell'
