/**
 * Real-process tests for `@harness-desktop/dsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@harness-desktop/dsh-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@harness-desktop/dsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@harness-desktop/dsh-timeout'
import type { ShellProcess } from '@harness-desktop/dsh-shell'
