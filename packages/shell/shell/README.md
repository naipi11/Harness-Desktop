...
| Package | Role |
|---|---|
| `@stackstackstack/dsh-shell` (this) | Service Definition: abstract service + vocabulary types |
| `@stackstackstack/dsh-bash-local` | Service Provider: local subprocesses |
| `@stackstackstack/dsh-bash-sandbox` | Service Provider: `dsh-bash-local`'s mechanics with every spawn confined via [`ctx.sandbox`](../../sandbox/sandbox/), denials reported as result facts |
| `@stackstackstack/dsh-tool-bash` | the model-facing tool schemas over `ctx.shell` |
