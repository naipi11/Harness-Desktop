/**
 * Package-owned invariant companion for `@harness-desktop/dsh-shell-env`.
 * @module @harness-desktop/dsh-shell-env/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-shell-env'
