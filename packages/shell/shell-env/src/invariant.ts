/**
 * Package-owned invariant companion for `@stackstackstack/dsh-shell-env`.
 * @module @stackstackstack/dsh-shell-env/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-shell-env'
