 ...
 * `@stackstackstack/dsh-pwsh-local`) backs `ctx.shell`; the tool contract is
 ...
 * exit-status parse from `@stackstackstack/dsh-shell`.
 *
 * @module @stackstackstack/dsh-tool-pwsh
 */

import { isAbsolute, resolve as resolvePath } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { defineTool, TOOL_ABORTED } from '@stackstackstack/dsh-tools'
import type { GenericCallView, TerminalCallView, ToolExecution, ToolResult, ToolResultView } from '@stackstackstack/dsh-tools'
...
import type {} from '@stackstackstack/dsh-shell-env'
...
import { ESCALATION_TARGETS, approveEscalation, validateEscalationArgs } from '@stackstackstack/dsh-sandbox'
import type { SandboxPolicyService } from '@stackstackstack/dsh-sandbox-policy'
import type { ShellRunResult } from '@stackstackstack/dsh-shell'
import { parseExitStatus } from '@stackstackstack/dsh-shell'
import { processOutcome } from './background.ts'
import { renderPwshProcessRead, renderPwshResult } from './render.ts'
import type { RenderablePwshResult } from './render.ts'

declare module '@stackstackstack/dsh-jobs' {
