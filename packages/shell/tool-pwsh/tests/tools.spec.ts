...
import SystemPrompt, { renderPrompt } from '@stackstackstack/dsh-system-prompt'
import ToolRuntime, { TOOL_ABORTED, TOOL_ABORTED_BEFORE_DISPATCH } from '@stackstackstack/dsh-tools'
...
import ApprovalService from '@stackstackstack/dsh-user-approval'
import type { ApprovalOutcome } from '@stackstackstack/dsh-user-approval'
import { ShellExecutor } from '@stackstackstack/dsh-shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellRunResult } from '@stackstackstack/dsh-shell'
...
import type { ShellProcessRead } from '@stackstackstack/dsh-shell'
...
describe('background execution through the job runtime', () => {
  ...
  it('fails loud when the job runtime is not loaded', async () => {
    ...
    expect(result.isError).toBe(true)
    expect(text(result)).toContain('background jobs unavailable: load @stackstackstack/dsh-jobs and @stackstackstack/dsh-tool-jobs')
  })
