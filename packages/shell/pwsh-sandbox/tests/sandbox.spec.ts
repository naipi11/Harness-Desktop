...
import type { ConfinedArgv, RunnerFailureRule, SandboxExecutionPolicy, SandboxPolicy } from '@harness-desktop/dsh-sandbox'
import { resolvePwshPath } from '@harness-desktop/dsh-pwsh-local'
