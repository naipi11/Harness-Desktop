/**
 * Package-owned invariant companion for `@harness-desktop/dsh-pwsh-sandbox`.
 * @module @harness-desktop/dsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-pwsh-sandbox'
