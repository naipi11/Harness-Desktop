/**
 * Package-owned invariant companion for `@stackstackstack/dsh-pwsh-sandbox`.
 * @module @stackstackstack/dsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-pwsh-sandbox'
