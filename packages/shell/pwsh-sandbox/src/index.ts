 ...
 * `@stackstackstack/dsh-bash-sandbox`. It wraps the exact local pwsh argv through
...
import type {
  ...
  SandboxMode,
  SandboxPolicy,
} from '@stackstackstack/dsh-sandbox'
import type {} from '@stackstackstack/dsh-sandbox-policy'
import { PwshLocalExecutor } from '@stackstackstack/dsh-pwsh-local'
import type { Config as LocalConfig } from '@stackstackstack/dsh-pwsh-local'
