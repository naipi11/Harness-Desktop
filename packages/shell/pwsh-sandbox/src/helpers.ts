 ...
 * mirror of `@harness-desktop/dsh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @harness-desktop/dsh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@harness-desktop/dsh-shell'
import type { RunnerFailureRule } from '@harness-desktop/dsh-sandbox'
