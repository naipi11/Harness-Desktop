...
import { CallId, createMessage, createUserMessage } from '@stackstackstack/dsh-llm'
import type { ContentBlock, GenerateOptions, Message } from '@stackstackstack/dsh-llm'
