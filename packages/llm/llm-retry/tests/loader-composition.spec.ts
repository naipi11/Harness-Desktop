...
import LlmRuntime, { createUserMessage, LlmAdapter, LlmError, resolveRetryPolicy  } from '@stackstackstack/dsh-llm'
import type { GenerateOptions, ResolvedRetryPolicy, StreamChunk } from '@stackstackstack/dsh-llm'
...
async function loadYaml(lines: readonly string[]): Promise<Context> {
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@stackstackstack/dsh-llm-retry', retry],
    ['@stackstackstack/dsh-agent-loop', AgentLoop],
  ])
