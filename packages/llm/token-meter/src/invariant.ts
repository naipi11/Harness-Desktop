/**
 * Package-owned invariant companion for `@harness-desktop/dsh-token-meter`.
 * @module @harness-desktop/dsh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-token-meter'
