/**
 * Package-owned invariant companion for `@stackstackstack/dsh-token-meter`.
 * @module @stackstackstack/dsh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-token-meter'
