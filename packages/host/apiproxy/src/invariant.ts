/**
 * Package-owned invariant companion for `@harness-desktop/dsh-host-apiproxy`.
 * @module @harness-desktop/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-host-apiproxy'
