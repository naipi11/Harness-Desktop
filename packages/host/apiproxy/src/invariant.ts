/**
 * Package-owned invariant companion for `@stackstackstack/dsh-host-apiproxy`.
 * @module @stackstackstack/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-host-apiproxy'
