...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@stackstackstack/dsh-attachment'
import type { ContentBlock } from '@stackstackstack/dsh-llm/types'
import type { SessionEvent, SessionId } from '@stackstackstack/dsh-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@stackstackstack/dsh-session-projection/types'
