...
import type { AskUserQuestionItem } from '@stackstackstack/dsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@stackstackstack/dsh-user-approval/types'
import type { Message } from '@stackstackstack/dsh-llm/types'
import type { MessageId } from '@stackstackstack/dsh-llm/brand'
import type { CallId } from '@stackstackstack/dsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@stackstackstack/dsh-session/types'
import type { ToolCallView, ToolResultView } from '@stackstackstack/dsh-tools/presentation'
...
export type { ToolCallView, ToolResultView } from '@stackstackstack/dsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@stackstackstack/dsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
