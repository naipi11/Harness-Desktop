...
import type { AskUserQuestionItem } from '@harness-desktop/dsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@harness-desktop/dsh-user-approval/types'
import type { Message } from '@harness-desktop/dsh-llm/types'
import type { MessageId } from '@harness-desktop/dsh-llm/brand'
import type { CallId } from '@harness-desktop/dsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@harness-desktop/dsh-session/types'
import type { ToolCallView, ToolResultView } from '@harness-desktop/dsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@harness-desktop/dsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
