...
import AgentRegistry, { agentEvents } from '@stackstackstack/dsh-agent'
import type { Agent, AgentHandle, CreateAgentOptions } from '@stackstackstack/dsh-agent'
...
import type { Workspace } from '@stackstackstack/dsh-workspace'
