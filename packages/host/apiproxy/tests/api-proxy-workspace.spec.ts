...
import type { Agent, AgentFactory } from '@stackstackstack/dsh-agent'
...
import { DomainFacility } from '@stackstackstack/dsh-storage-domain'
...
import type { DirectoryPickerCapability } from '@stackstackstack/dsh-host-directory-picker'
import WorkspaceRegistry from '@stackstackstack/dsh-workspace'
import type { HostFrame, WorkspaceId } from '@stackstackstack/dsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@stackstackstack/dsh-host-apiproxy/api/rpc'
