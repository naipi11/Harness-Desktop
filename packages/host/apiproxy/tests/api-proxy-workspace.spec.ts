...
import type { Agent, AgentFactory } from '@harness-desktop/dsh-agent'
...
import type { DirectoryPickerCapability } from '@harness-desktop/dsh-host-directory-picker'
import WorkspaceRegistry from '@harness-desktop/dsh-workspace'
import type { HostFrame, WorkspaceId } from '@harness-desktop/dsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@harness-desktop/dsh-host-apiproxy/api/rpc'
