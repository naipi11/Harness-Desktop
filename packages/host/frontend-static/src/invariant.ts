/**
 * Package-owned invariant companion for `@harness-desktop/dsh-host-frontend-static`.
 * @module @harness-desktop/dsh-host-frontend-static/invariant
 */

import type { Context } from '@harness-desktop/cordis'
import type { InvariantInstaller } from '@harness-desktop/dsh-invariants'

const PACKAGE_NAME = '@harness-desktop/dsh-host-frontend-static'
