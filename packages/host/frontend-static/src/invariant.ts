/**
 * Package-owned invariant companion for `@stackstackstack/dsh-host-frontend-static`.
 * @module @stackstackstack/dsh-host-frontend-static/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@stackstackstack/dsh-invariants'

const PACKAGE_NAME = '@stackstackstack/dsh-host-frontend-static'
