...
import HttpServer from '@stackstackstack/dsh-host-webserver'
import type { DirectoryPicker } from '@stackstackstack/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@stackstackstack/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@stackstackstack/dsh-host-directory-picker-native'
...
const AUTO = '@stackstackstack/dsh-host-directory-picker-auto'
const NATIVE = '@stackstackstack/dsh-host-directory-picker-native'
const BROWSE = '@stackstackstack/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@stackstackstack/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@stackstackstack/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@stackstackstack/dsh-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@stackstackstack/dsh-host-webserver', HttpServer],
