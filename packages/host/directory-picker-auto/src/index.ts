 ...
 * @module @harness-desktop/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@harness-desktop/dsh-host-directory-picker-native',
  browse: '@harness-desktop/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@harness-desktop/dsh-client-ui-directory-picker-native',
  browse: '@harness-desktop/dsh-client-ui-directory-picker-browse',
}
