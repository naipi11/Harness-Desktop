/** Package-owned invariant companion for the directory-picker seam. @module @harness-desktop/dsh-host-directory-picker/invariant */

import type { Context } from '@harness-desktop/cordis'
import type { InvariantInstaller } from '@harness-desktop/dsh-invariants'

const PACKAGE_NAME = '@harness-desktop/dsh-host-directory-picker'
