 ...
 * entry next to this module under Node; Electron consumers explicitly select
 * Node mode for this child even after the Runtime consumes its own marker.
 * Unbuilt (source) consumers
