/**
 * Package-owned invariant companion for `@harness-desktop/dsh-host-webserver`.
 * @module @harness-desktop/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-host-webserver'
