/**
 * Package-owned invariant companion for `@stackstackstack/dsh-host-webserver`.
 * @module @stackstackstack/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-host-webserver'
