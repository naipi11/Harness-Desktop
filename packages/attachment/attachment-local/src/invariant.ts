/** Package-owned invariant companion for `@harness-desktop/dsh-attachment-local`.
 * @module @harness-desktop/dsh-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@harness-desktop/cordis'
import type { InvariantInstaller } from '@harness-desktop/dsh-invariants'

const PACKAGE_NAME = '@harness-desktop/dsh-attachment-local'
