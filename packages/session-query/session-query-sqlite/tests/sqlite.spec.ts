import { createAssistantMessage, createUserMessage } from '@harness-desktop/dsh-llm'
import { afterEach, describe, expect, it, vi } from 'vitest'
import { Context, type Fiber } from '@harness-desktop/cordis'
import { DatabaseSync } from 'node:sqlite'
import { chmod, mkdtemp, rm, stat, writeFile } from 'node:fs/promises'
import { tmpdir } from 'node:os'
import { dirname, join } from 'node:path'
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@harness-desktop/dsh-session'
import type { SessionEvent, SessionHeader, SessionId as SessionIdType } from '@harness-desktop/dsh-session'
import SessionPersistence, { SessionPersistenceRevision } from '@harness-desktop/dsh-session-persistence'
import type { SessionPersistenceSnapshot } from '@harness-desktop/dsh-session-persistence'
import SqliteSessionPersistence from '@harness-desktop/dsh-session-persistence-sqlite'
import SqliteSessionQueryEngine, {
  SESSION_QUERY_SQLITE_SCHEMA_VERSION,
} from '@harness-desktop/dsh-session-query-sqlite'
import {
