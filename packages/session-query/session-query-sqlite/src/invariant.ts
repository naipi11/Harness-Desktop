/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-query-sqlite`.
 * @module @harness-desktop/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-query-sqlite'
