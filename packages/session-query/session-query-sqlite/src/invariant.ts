/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-query-sqlite`.
 * @module @stackstackstack/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-query-sqlite'
