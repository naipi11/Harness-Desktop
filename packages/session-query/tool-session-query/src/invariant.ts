/**
 * Package-owned invariant companion for `@stackstackstack/dsh-tool-session-query`.
 * @module @stackstackstack/dsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-tool-session-query'
