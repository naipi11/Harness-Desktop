/**
 * Package-owned invariant companion for `@harness-desktop/dsh-session-query`.
 * @module @harness-desktop/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@harness-desktop/dsh-session-query'
