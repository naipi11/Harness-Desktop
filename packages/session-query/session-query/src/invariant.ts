/**
 * Package-owned invariant companion for `@stackstackstack/dsh-session-query`.
 * @module @stackstackstack/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@stackstackstack/dsh-session-query'
