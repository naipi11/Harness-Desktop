...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@harness-desktop/dsh-session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@harness-desktop/dsh-session'
