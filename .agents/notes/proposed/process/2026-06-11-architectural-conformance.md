...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@harness-desktop/dsh-agent-loop`.
- No cross-package deep imports (`@harness-desktop/dsh-*/src/...` paths) — public entry points only.
