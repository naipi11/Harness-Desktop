...
| 包 | 路径 | ctx 面 | 本期 |
| --- | --- | --- | --- |
| `@harness-desktop/dsh-storage` | `packages/storage/storage/` | `ctx.storage`（枢纽） | ✓ |
| `@harness-desktop/dsh-storage-json` | `packages/storage/storage-json/` | 注册后端 `json` | ✓ |
| `@harness-desktop/dsh-storage-sqlite` | `packages/storage/storage-sqlite/` | 注册后端 `sqlite` | ✓ |
| `@harness-desktop/dsh-storage-domain` | `packages/storage/storage-domain/` | 挂载 `ctx.storage.domain` | ✓ |
