...
| --- | --- | --- | --- |
| `@harness-desktop/dsh-storage` | `packages/storage/storage/` | `ctx.storage` (the hub) | ✓ |
| `@harness-desktop/dsh-storage-json` | `packages/storage/storage-json/` | registers backend `json` | ✓ |
| `@harness-desktop/dsh-storage-sqlite` | `packages/storage/storage-sqlite/` | registers backend `sqlite` | ✓ |
| `@harness-desktop/dsh-storage-domain` | `packages/storage/storage-domain/` | mounts `ctx.storage.domain` | ✓ |
| `@harness-desktop/dsh-workspace` | `packages/workspace/workspace/` | `ctx.workspaceRegistry` | ✓ |
