...
- Source and built process acceptance pin the same public connector and canonical composition. CLI, Web, Desktop, packaging, and cross-client presentation acceptance remain downstream work.
