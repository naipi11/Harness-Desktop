...
const CHOOSER_PACKAGE = '@stackstackstack/dsh-host-directory-picker-auto'
...
const CHOOSER_BACKEND_PACKAGES = [
  '@stackstackstack/dsh-host-directory-picker-native',
  '@stackstackstack/dsh-host-directory-picker-browse',
  '@stackstackstack/dsh-client-ui-directory-picker-browse',
  '@stackstackstack/dsh-client-ui-directory-picker-native',
]
