...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/credentials/credentials-platform': { kind: 'indirect', reason: 'The provider resolves credential references for adapters that own their model-visible calls.' },
  ...
  'packages/test-support/cross-client-runtime': { kind: 'none', reason: 'The fixture drives public operations while the canonical Runtime composition owns model-visible inputs.' },
