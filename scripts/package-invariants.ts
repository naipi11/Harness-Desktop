...
function checkManifest(
  ...
  if (owner.packageName === '@harness-desktop/dsh-invariants') return
  if (manifest.peerDependencies?.['@harness-desktop/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@harness-desktop/dsh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@harness-desktop/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@harness-desktop/dsh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@harness-desktop/dsh-invariants'
