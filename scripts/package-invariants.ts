...
function checkManifest(
  ...
  if (owner.packageName === '@stackstackstack/dsh-invariants') return
  if (manifest.peerDependencies?.['@stackstackstack/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@stackstackstack/dsh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@stackstackstack/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@stackstackstack/dsh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@stackstackstack/dsh-invariants'
