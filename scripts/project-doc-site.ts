...
const REPOSITORY_URL = 'https://github.com/naipi11/Harness-Desktop'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/naipi11/Harness-Desktop/${repositoryRef}/${path}${suffix}`
