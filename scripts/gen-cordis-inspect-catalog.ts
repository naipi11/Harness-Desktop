...
import type { CordisCatalogModel, ServiceMethodEntry } from '@stackstackstack/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@stackstackstack/dsh-tool-cordis/api-catalog', '@stackstackstack/dsh-cordis-client-runner/client/api-catalog')
