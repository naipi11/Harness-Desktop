...
import type { CordisCatalogModel, ServiceMethodEntry } from '@harness-desktop/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@harness-desktop/dsh-tool-cordis/api-catalog', '@harness-desktop/dsh-cordis-client-runner/client/api-catalog')
