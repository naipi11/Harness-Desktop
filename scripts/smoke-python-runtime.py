...
- id: sdk-jsonrpc-server
  name: '@stackstackstack/dsh-sdk-jsonrpc-server'
- id: agent-core
  name: '@stackstackstack/dsh-agent-spine-demo'
  config:
...
- id: sessions
  ...
  config:
    ...
    compression: 'none'
- id: code-runtime
  name: '@stackstackstack/dsh-code-runtime-worker-thread'
- id: subagents
  name: '@stackstackstack/dsh-subagent'
- id: subagent-spawn-in-process
  name: '@stackstackstack/dsh-subagent-spawn-in-process'
  config:
    providerName: spawn
- id: subagent-tool
  ...
  config:
    provider: spawn
- id: workflow-engine
  name: '@stackstackstack/dsh-workflow-worker-thread'
  config:
    provider: spawn
- id: workflow-tool
  name: '@stackstackstack/dsh-tool-workflow'
- id: cordis-host-runner
  name: '@stackstackstack/dsh-cordis-host-runner'
- id: cordis-tool
  name: '@stackstackstack/dsh-tool-cordis'
"""
