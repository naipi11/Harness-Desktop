...
- id: sdk-jsonrpc-server
  name: '@harness-desktop/dsh-sdk-jsonrpc-server'
- id: agent-core
  name: '@harness-desktop/dsh-agent-spine-demo'
  config:
...
- id: sessions
  ...
  config:
    ...
    compression: 'none'
- id: code-runtime
  name: '@harness-desktop/dsh-code-runtime-worker-thread'
- id: subagents
  name: '@harness-desktop/dsh-subagent'
- id: subagent-spawn-in-process
  name: '@harness-desktop/dsh-subagent-spawn-in-process'
  config:
    providerName: spawn
- id: subagent-tool
...
- id: cordis-host-runner
  name: '@harness-desktop/dsh-cordis-host-runner'
- id: cordis-tool
  name: '@harness-desktop/dsh-tool-cordis'
"""
