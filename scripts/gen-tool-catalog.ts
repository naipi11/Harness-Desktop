...
import type { ToolSchema } from '@harness-desktop/dsh-llm'
...
import SqliteSessionQueryEngine from '@harness-desktop/dsh-session-query-sqlite'
import GoalService from '@harness-desktop/dsh-goal'
import SystemPrompt from '@harness-desktop/dsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@harness-desktop/dsh-tools'
import LocalBashExecutor from '@harness-desktop/dsh-bash-local'
import * as BashEnvPlugin from '@harness-desktop/dsh-shell-env'
import { PwshLocalExecutor } from '@harness-desktop/dsh-pwsh-local'
...
import PlanModeController from '@harness-desktop/dsh-plan-mode'
import WebRuntime from '@harness-desktop/dsh-web'
import * as WebSearchExa from '@harness-desktop/dsh-web-search-exa'
import * as WebFetchLocal from '@harness-desktop/dsh-web-fetch-http'
import SubagentRuntime from '@harness-desktop/dsh-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@harness-desktop/dsh-subagent'
import * as ToolSubagentControl from '@harness-desktop/dsh-tool-subagent-control'
import * as ToolSubagentListAgents from '@harness-desktop/dsh-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@harness-desktop/dsh-tool-subagent-report'
...
import * as ToolAskUser from '@harness-desktop/dsh-tool-ask-user'
import * as ToolBash from '@harness-desktop/dsh-tool-bash'
import * as ToolPwsh from '@harness-desktop/dsh-tool-pwsh'
import * as ToolBashPersistent from '@harness-desktop/dsh-tool-bash-persistent'
import CordisHostRunner from '@harness-desktop/dsh-cordis-host-runner'
import * as ToolCordis from '@harness-desktop/dsh-tool-cordis'
import * as ToolFs from '@harness-desktop/dsh-tool-fs'
import * as ToolFsSearch from '@harness-desktop/dsh-tool-fs-search'
import * as ToolStrReplaceEditor from '@harness-desktop/dsh-tool-str-replace-editor'
import TerminalSessionService from '@harness-desktop/dsh-terminal'
import * as ToolPty from '@harness-desktop/dsh-tool-terminal'
import * as ToolGoal from '@harness-desktop/dsh-tool-goal'
import * as ToolSchedule from '@harness-desktop/dsh-schedule'
import Lsp from '@harness-desktop/dsh-lsp'
import * as ToolLsp from '@harness-desktop/dsh-tool-lsp'
import * as ToolSkill from '@harness-desktop/dsh-tool-skill'
import * as ToolSessionQuery from '@harness-desktop/dsh-tool-session-query'
import * as ToolTasks from '@harness-desktop/dsh-tool-jobs'
import * as ToolTodo from '@harness-desktop/dsh-tool-todo'
import * as ToolSubagent from '@harness-desktop/dsh-tool-subagent'
import * as ToolWeb from '@harness-desktop/dsh-tool-web'
import VmWorkflowEngine from '@harness-desktop/dsh-workflow-worker-thread'
import * as ToolRalph from '@harness-desktop/dsh-tool-ralph'
import * as ToolWorkflow from '@harness-desktop/dsh-tool-workflow'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@harness-desktop/dsh-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  {
    pkg: '@harness-desktop/dsh-plan-mode',
    dir: 'plan-mode',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-bash',
    dir: 'tool-bash',
    ...
    note:
      'The bash tool is the model-facing consumer of the bash executor seam. A `run_in_background` run registers with the generic `ctx.jobs` runtime and is collected/stopped through the `job_*` tools from `@harness-desktop/dsh-tool-jobs`; the `enableRunInBackground` config (default true) removes the parameter entirely when disabled.',
  },
  {
    pkg: '@harness-desktop/dsh-tool-pwsh',
    dir: 'tool-pwsh',
    ...
    note:
      'The pwsh tool is the PowerShell-dialect consumer of the bash executor seam for Windows compositions (a PowerShell executor such as `@harness-desktop/dsh-pwsh-local` backs `ctx.shell`); it mirrors the bash tool call-for-call minus sandbox controls — `run_in_background` runs register with the generic `ctx.jobs` runtime and are collected/stopped through the `job_*` tools, and the managed `DSH_*` environment comes from `@harness-desktop/dsh-shell-env`. Each call runs in a fresh process (no persistent PTY session), with native `C:\\...` paths and `$env:NAME` variables.',
  },
  {
    pkg: '@harness-desktop/dsh-tool-cordis',
    dir: 'tool-cordis',
    ...
    note:
      'Not in any shipped tree (a deliberate opt-in — dynamic package code reaches the real runtime, see .agents/notes/implemented/feature/2026-07-08-self-referential-cordis-toolset.md). The toolset injects `ctx.dynamicCordisRunner` from `@harness-desktop/dsh-cordis-host-runner`, which owns the definition registry and the vm sandbox; a composition missing it never activates the tools. A running package may register ADDITIONAL model-visible tools until it is stopped, undefined, or DSH restarts; a full changed request header logs those tool-set changes.',
  },
  {
    pkg: '@harness-desktop/dsh-tool-bash-persistent',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-str-replace-editor',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-fs',
    dir: 'tool-fs',
    ...
    note:
      'The read-before-write/edit policy is added by `@harness-desktop/dsh-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. `read_image` is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@harness-desktop/dsh-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-terminal',
    dir: 'tool-terminal',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-goal',
    dir: 'tool-goal',
  ...
  {
    pkg: '@harness-desktop/dsh-schedule',
    dir: 'schedule',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-lsp',
    dir: 'tool-lsp',
    ...
    note:
      'The lsp tool keeps provider selection and language-server subprocesses behind ctx.lsp, so its model-visible schema stays stable across providers. Requires a registered provider (e.g. `@harness-desktop/dsh-lsp-stdio`) at runtime; without one, a query returns the structured `LSP_UNAVAILABLE` error rather than changing the schema.',
  },
  {
    pkg: '@harness-desktop/dsh-tool-ralph',
    dir: 'tool-ralph',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-skill',
    dir: 'tool-skill',
    ...
    async mount(ctx) {
      ...
      await ctx.plugin(SkillFileSystem, {
        harnessHome: resolve(root, '.tmp/tool-catalog/.dsh'),
  ...
  {
    pkg: '@harness-desktop/dsh-tool-session-query',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-subagent',
    dir: 'tool-subagent',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-subagent-control',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-subagent-report',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-jobs',
    dir: 'tool-jobs',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-todo',
    dir: 'tool-todo',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-workflow',
    dir: 'tool-workflow',
  ...
  {
    pkg: '@harness-desktop/dsh-tool-web',
    dir: 'tool-web',
