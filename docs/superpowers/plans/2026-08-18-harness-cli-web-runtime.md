...
- Historical correction: this plan predates the strict CLI JSONL reader. The reader accepts one final line terminator and rejects every leading or interior blank physical record with its original line number.
