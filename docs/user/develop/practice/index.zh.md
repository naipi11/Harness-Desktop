...
import { MyCapService, type MyCapRequest, type MyCapResult } from '@harness-desktop/dsh-my-cap'
...
```yaml
- name: '@harness-desktop/dsh-my-cap-local'
- name: '@harness-desktop/dsh-tool-my-cap'
```
