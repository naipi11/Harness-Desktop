...
import { MyCapService, type MyCapRequest, type MyCapResult } from '@stackstackstack/dsh-my-cap'
...
```yaml
- name: '@stackstackstack/dsh-my-cap-local'
- name: '@stackstackstack/dsh-tool-my-cap'
```
