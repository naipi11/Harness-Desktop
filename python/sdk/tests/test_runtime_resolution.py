...
def test_default_config_is_shipped_with_the_package() -> None:
    ...
    assert "@stackstackstack/dsh-agent-spine-demo" in config
    assert "@stackstackstack/dsh-session-persistence-jsonl" in config
    assert "@stackstackstack/dsh-session-checkpoint-policy" in config
