...
describe('dsh badge assembled snapshot', () => {
  it('advertises and loads the opt-in bundled skill through the shipped app', async () => {
    ...
    expect(enabledSnapshot).toMatchInlineSnapshot(`
      ...
      - Project URL: \`https://github.com/naipi11/Harness-Desktop\`
      ...
      \`\`\`markdown
      [![](https://img.shields.io/badge/powered_by-dsh-4D6BFE?style=flat-square&logo=deepseek&logoColor=white)](https://github.com/naipi11/Harness-Desktop)
      \`\`\`
