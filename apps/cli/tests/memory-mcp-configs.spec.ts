...
import { boot, loadOverlayPatches } from '@stackstackstack/dsh-app-boot'
import SystemPrompt from '@stackstackstack/dsh-system-prompt'
import ToolRuntime from '@stackstackstack/dsh-tools'
import * as McpClient from '@stackstackstack/dsh-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@stackstackstack/dsh-mcp-client')
