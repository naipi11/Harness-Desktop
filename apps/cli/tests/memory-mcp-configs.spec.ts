...
import { boot, loadOverlayPatches } from '@harness-desktop/dsh-app-boot'
import SystemPrompt from '@harness-desktop/dsh-system-prompt'
import ToolRuntime from '@harness-desktop/dsh-tools'
import * as McpClient from '@harness-desktop/dsh-mcp-client/src/index.ts'
...
describe('third-party memory MCP example overlays', () => {
  it.each(examples)('parses $file with the documented generic plugin fields', (contract) => {
    ...
    expect(row.name).toBe('@harness-desktop/dsh-mcp-client')
