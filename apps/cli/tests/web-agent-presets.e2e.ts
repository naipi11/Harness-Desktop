...
import { boot, healProfilesModuleFallback, loadOverlayPatches } from '@stackstackstack/dsh-app-boot'
...
import { resolveSessionPreset, SETTINGS_NAMESPACE } from '@stackstackstack/dsh-agent-presets'
import { applyChildComposition, childSessionMeta } from '@stackstackstack/dsh-subagent'
import { CallId } from '@stackstackstack/dsh-llm'
import type {} from '@stackstackstack/dsh-compaction-basic'
...
import type {} from '@stackstackstack/dsh-token-meter'
...
describe('product subagent rows in user presets', () => {
  ...
  beforeAll(async () => {
    ...
    productCtx = await bootWeb(settingsFile, [
      { insert: [
        { id: 'subagent-codex', name: '@stackstackstack/dsh-subagent-codex' },
        { id: 'subagent-claude-code', name: '@stackstackstack/dsh-subagent-claude-code' },
      ] },
      {
        id: 'agent-presets',
        config: {
...
describe('a launcher that configures no writable root', () => {
  ...
  beforeAll(async () => {
    ...
    await writeFile(
      ...
      '- id: tool-todo\n  name: \'@stackstackstack/dsh-tool-todo\'\n  config:\n    allowParallelInProgress: true\n',
    )
