...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  for (const plugin of ['@harness-desktop/dsh-client-ui-layout', '@harness-desktop/dsh-client-ui-sidebar', '@harness-desktop/dsh-client-ui-conversation', '@harness-desktop/dsh-client-ui-tool']) {
