...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  for (const plugin of ['@stackstackstack/dsh-client-ui-layout', '@stackstackstack/dsh-client-ui-sidebar', '@stackstackstack/dsh-client-ui-conversation', '@stackstackstack/dsh-client-ui-tool']) {
