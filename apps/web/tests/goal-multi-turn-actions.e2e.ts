...
import type {} from '@stackstackstack/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@stackstackstack/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@stackstackstack/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@stackstackstack/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@stackstackstack/dsh-skill-filesystem"}\n',
