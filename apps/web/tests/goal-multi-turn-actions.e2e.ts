...
import { parseSessionLog } from '@harness-desktop/dsh-llm-replay'
import type { SessionEvent, SessionId } from '@harness-desktop/dsh-session'
import type {} from '@harness-desktop/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@harness-desktop/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@harness-desktop/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@harness-desktop/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@harness-desktop/dsh-skill-filesystem"}\n',
